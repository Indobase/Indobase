...
export const ONBOARDING_TIPS: OnboardingTipContent[] = [
  {
    ...
    body: `Thanks for signing up for Indobase Analytics. You've joined thousands of developers who care about respecting their users' privacy.

Unlike traditional analytics tools, Indobase Analytics doesn't use cookies, doesn't track users across websites, and doesn't sell your data to advertisers. Your visitors stay anonymous, and you still get the insights you need.

We built Indobase Analytics because we were tired of tools that treat users as products. Privacy shouldn't mean giving up on understanding your audience.

If you're curious how we compare to other tools, check out our comparison page.`,
    linkText: "View comparison",
    linkUrl: "https://github.com/Indobase/Indobase/blob/main/docs/INDOBASE-ANALYTICS.md",
  },
  {
    day: 2,
    subject: "Why your metrics might look different than GA",
    body: `If you've been using Google Analytics before, you might notice your Indobase Analytics numbers look different. That's actually a good thing.

Adblockers block Google Analytics. They rarely block Indobase Analytics. So for the first time, you're probably seeing your real traffic - and it's likely higher than GA ever showed you.
...
window.indobase.event("signup_clicked")
...
Funnels go deeper. Define a multi-step process (view product -> add to cart -> checkout -> purchase) and see exactly where users drop off. Finding a 60% drop-off at checkout? Now you know where to focus.`,
  ...
  },
  {
    ...
    body: `Everything in your Indobase Analytics dashboard is available through our API.
