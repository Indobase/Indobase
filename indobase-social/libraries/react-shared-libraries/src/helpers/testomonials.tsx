export const testimonials1 = [
  ...
  },
  {
    ...
    content: (
      <>
        I just found out about Indobase Social, a tool for scheduling social media.{' '}
        {'\n'}
        ...
        {'\n'}
        Indobase Social seems to focus on just doing one thing well. {'\n'}
        {'\n'}
      </>
    ),
  },
  {
    ...
    content: (
      <>
        As a privacy-first company we appreciate being able to self-host Indobase Social!
  ...
  },
  {
    ...
    content: (
      <>
        Indobase Social changed how we manage our social media presence by aggregating
        our platforms into one effective tool. Post scheduling, and AI post
        ideation are two of the many features that come with Indobase Social, and have
  ...
  },
  {
    ...
    content: (
      <>
        ...
        n8n + Indobase Social =🔥Never miss a day of posting again: {'\n\n'}→ Easy to get
  ...
  },
  {
    ...
    content: (
      <>
        Manage all your social media accounts from a single place: Indobase Social, a
...
export const testimonials2 = [
  {
    ...
    content: (
      <>
        🌟 Exciting news! 🚀 I've just started using Indobase Social, a fantastic new
        tool for scheduling my social media content! {'\n\n'}
        Why did I choose Indobase Social? The ability to self-host it means significant
        savings for me! 💰 {'\n\n'}
        Indobase Social is an open-source scheduling tool that allows you to plan and
        ...
        scheduling! 📅✨ {'\n\n'}
        Built with privacy and flexibility in mind, Indobase Social can run on your own
  ...
  },
  {
    ...
    content: (
      <>
        Indobase Social makes it so easy to plan ahead. The AI suggestions are relevant,
