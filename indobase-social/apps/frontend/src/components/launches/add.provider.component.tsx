    ...
    <div className="flex flex-col gap-[16px] pt-[8px]">
      <p className="text-[14px] text-textColor/80">
        {t(
          ...
          'The Indobase Social browser extension is not installed. You need to install it before connecting this channel.'
        )}
      </p>
  ...
  return (
    <div className="flex flex-col gap-[16px] pt-[8px]">
      ...
      <ul className="flex flex-col gap-[8px] list-disc ps-[20px] text-[14px] text-textColor/80">
        ...
        <li>
          Indobase Social does not take responsibility for any issues arising or account
    ...
    (
      ...
      async () => {
        ...
        const gotoIntegration = async (externalUrl?: string) => {
          ...
          // carry the `indobase-social://` deep link so the backend redirects
          ...
          const params = [
            ...
            onboardingParam,
            isMobile
              ? `redirectUrl=${encodeURIComponent('indobase-social://integrations')}`
              : '',
          ]
            .filter(Boolean)
            .join('&');
            ...
            toaster.show(
              message ||
                t(
                  ...
                  'Could not connect to the platform — OAuth may not be configured for this channel'
                ),
              'warning'
            );
            return;
          ...
          if (isMobile) {
            ...
            // app via `indobase-social://` once OAuth completes.
          ...
          try {
            ...
            toaster.show(
              t(
                ...
                'Indobase Social browser extension is not installed or not reachable.'
              ),
              'warning'
            );
            return;
