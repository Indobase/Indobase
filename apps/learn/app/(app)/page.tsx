...
export default function Home() {
  const courses = [
    {
      id: 1,
      title: 'Indobase Foundations',
      description: 'Learn the basics of Indobase: database, auth, and RLS.',
      chapters: 5,
      icon: Database,
      level: 'Beginner',
    },
    {
      ...
      description: 'Build a realtime room-booking dashboard using Indobase.',
      chapters: 15,
      icon: Activity,
      level: 'Intermediate',
    },
    {
      id: 3,
      title: 'Indobase Internals: Performance & Scaling',
      description: 'Learn how to profile queries, tune indexes, and scale Postgres with Indobase.',
      chapters: 20,
      icon: Gauge,
      level: 'Advanced',
    },
    {
      id: 4,
      title: 'Indobase Internals: Debugging & Operations',
      description:
                ...
                <div className="flex flex-col gap-8 justify-start pt-16 md:pt-32">
                  <div className="max-w-2xl">
                    ...
                    <h2 className="text-lg text-foreground-light mb-4">
                      Learn how to build your own projects with Indobase. Our courses and projects
