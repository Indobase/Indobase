...
explore:
  - title: Indobase Docs
    link: https://indobase.in/docs/guides/database/overview
    itemType: doc
...
Before we store any information in Indobase, we need to understand how data is
organized in Postgres. Indobase uses Postgres as its database, which means data
...
A database in Indobase is made up of tables.
Each table has:
...
Thinking in tables, rows, and relationships is the foundation of working with data in Indobase.
