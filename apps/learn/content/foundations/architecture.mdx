...
You interact with Indobase mainly through the API layer or the client libraries.
...
relationships using SQL or the visual editor in Indobase Studio. Supabase
