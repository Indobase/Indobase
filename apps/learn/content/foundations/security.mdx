---
title: Security
description: Learn how Indobase uses Row Level Security (RLS) to control which data each user can access.
chapterNumber: 4
explore:
  - title: Indobase Docs
    link: https://indobase.in/docs/guides/database/postgres/row-level-security
    itemType: doc
...
each user is allowed to see or change. Indobase handles this using a Postgres
...
Understanding RLS is the foundation of secure Indobase applications.
