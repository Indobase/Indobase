...
Authentication in Indobase is handled by the Supabase Auth service. It manages creating accounts, signing in, and identifying the user on each request.

---

## Users

A user in Indobase has an id and some optional profile information (such as
