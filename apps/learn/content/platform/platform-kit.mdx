...
See the [Indobase Platform Kit documentation](https://indobase.in/docs) for installation instructions.
...
- [Indobase Management API](https://indobase.in/docs/reference/api/introduction)
