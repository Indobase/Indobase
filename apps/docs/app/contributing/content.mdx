...
Thanks for contributing to Indobase Docs! Here are a few resources to help you get started.

The code and content for our docs site are in this repo under `apps/docs`.

In the repo, you'll also find:

- The [developers guide](./DEVELOPERS.md), which will help you set up your local machine to develop the docs site
- The [contributing guide](./CONTRIBUTING.md), which goes over the content organization and some general guidelines for writing docs content
