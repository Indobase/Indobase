...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
    ...
    You can use the Indobase CLI to [generate the types](/docs/reference/cli/supabase-gen-types). You can also generate the types [from the dashboard](https://indobase.in/dashboard/project/_/api?page=tables-intro).
