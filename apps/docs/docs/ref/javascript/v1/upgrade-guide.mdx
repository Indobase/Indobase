...
For Next.js you can use the [Auth Helpers](https://indobase.in/docs/guides/auth/auth-helpers/nextjs) to help you manage cookies.
If you can't use the Auth Helpers, you can use [server-side rendering](https://indobase.in/docs/guides/auth/server-side-rendering).
