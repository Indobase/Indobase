...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
      ...
      2. **OAuth2:**
      OAuth2 allows your application to generate tokens on behalf of an Indobase user, providing secure and limited access to their account without requiring their credentials. Use this if you're building a third-party app that needs to create or manage Indobase projects on behalf of your users. Tokens generated via OAuth2 are short-lived and tied to specific scopes to ensure your app can only perform actions that are explicitly approved by the user.

          See [Build an Indobase Integration](/docs/guides/integrations/build-a-supabase-integration) to set up OAuth2 for your application.
      ...
      The Management API is subject to our fair-use policy. All resources created via the API are subject to the pricing detailed on our [Pricing](https://indobase.in/pricing) pages.
    ...
    <RefSubLayout.Examples>
      ...
      - [OpenAPI Docs](https://api.indobase.in/api/v1)
      - [OpenAPI Spec](https://api.indobase.in/api/v1-json)
      - [Report bugs and issues](https://github.com/Indobase/Indobase)
