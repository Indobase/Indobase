...
sidebar_position: 1
id: realtime
title: Indobase Realtime Server
sidebar_label: Indobase Realtime Server
---

Indobase Realtime is a server built with Elixir using the [Phoenix Framework](https://www.phoenixframework.org) that allows you to listen to changes in your PostgreSQL database via logical replication and then broadcast those changes via WebSockets.
...
- [Realtime Guides](https://indobase.in/docs/guides/realtime)
