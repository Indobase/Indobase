...
<div className="flex items-start gap-6 not-prose" id="introduction">
  <div className="flex flex-col gap-2">
    <h1 className="text-3xl text-foreground m-0">Indobase CLI</h1>
  </div>
</div>
...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
    ...
    The Indobase CLI provides tools to develop your project locally and deploy to the Indobase Platform.
    The CLI is still under development, but it contains all the functionality for working with your Indobase projects and the Indobase Platform.

    - Run Indobase locally: [`supabase init`](/docs/reference/cli/usage#supabase-init) and [`supabase start`](/docs/reference/cli/usage#supabase-start)
    ...
    - Manage your Indobase projects: [`supabase projects`](/docs/reference/cli/usage#supabase-projects)
  ...
  <RefSubLayout.Examples>
    ...
    - [Indobase CLI v1 and Management API Beta](https://indobase.in/blog/supabase-cli-v1-and-admin-api-beta)
