...
For more information on formats for redirect URL settings see the documentation here: https://indobase.in/docs/guides/auth/redirect-urls#use-wildcards-in-redirect-urls
