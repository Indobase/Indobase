...
More on this in our doc here: [**https://indobase.in/docs/guides/platform/database-size#disk-size**](/docs/guides/platform/database-size#disk-size).
