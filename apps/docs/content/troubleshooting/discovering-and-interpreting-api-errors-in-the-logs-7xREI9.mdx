...
| request.url           | Request URL, which contains the PostgREST formatted query | https://yuhplfrsdxxxtldakizi.indobase.in/rest/v1/users?select=username&id=eq.63b6190e-214f-4b8a-b72d-3af6e1921411&limit=1 |
...
```bash
https://<project ref>.indobase.in/rest/v1/countries?select=name
```
