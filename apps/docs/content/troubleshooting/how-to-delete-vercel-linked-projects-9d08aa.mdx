...
When you create Indobase projects through the Vercel Marketplace, complete deletion requires action on both platforms.
...
1. **Delete from Indobase Dashboard**
   ...
   ![Delete project button in Indobase project settings](/docs/img/troubleshooting/54428354-a1f4-4c44-bd03-d87f4b925d94.png)
...
2. **Clean up in Vercel**
   ...
   - Click on the Indobase project (it will show as "uninstalled")

   ![Uninstalled Indobase project in Vercel Storage](/docs/img/troubleshooting/cf450bca-aad3-4783-ae3b-5cc83e0afa54.png)
...
2. **Select your project**
   ...
   Click on your Indobase project to open it.
...
1. **Transfer the project**
   ...
   ![Transfer project option in Indobase project settings](/docs/img/troubleshooting/627c1a3e-153e-40b5-9a91-a4f7bd7673a4.png)
