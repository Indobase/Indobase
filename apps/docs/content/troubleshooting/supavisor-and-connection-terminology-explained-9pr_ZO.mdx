...
postgres://postgres.obfwhevidiamwdwki:[YPASSWORD]@[PROJECT-REF].indobase.in:**6543**/postgres
```
...
postgres://postgres.obfwhevidiamwdwki:[YPASSWORD]@[PROJECT-REF].indobase.in:**5432**/postgres
```
