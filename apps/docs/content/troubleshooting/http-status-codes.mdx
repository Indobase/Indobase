...
You will still have access to your data through the Indobase dashboard when the Fair Use Policy is applied.
...
54X status codes are custom codes used by the Indobase platform to indicate the state of the project.
