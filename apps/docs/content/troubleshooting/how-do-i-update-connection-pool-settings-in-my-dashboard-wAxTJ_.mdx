...
- How to tell which connection pooler you're using:
  The PgBouncer connection string looks like: `postgres://postgres:[YOUR-PASSWORD]@db.xxxxxxxxxx.indobase.in:6543/postgres`

The Supavisor connection string looks like: `postgres://postgres.xxxxxxxxx:[YOUR-PASSWORD]@[PROJECT-REF].indobase.in:6543/postgres`
...
[https://indobase.in/dashboard/project/\_/database/settings](/dashboard/project/_/database/settings)
