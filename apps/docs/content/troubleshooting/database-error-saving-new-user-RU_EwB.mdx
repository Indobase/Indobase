...
You generally get this error when trying to invite a new user from the dashboard or when trying to insert a user into a table using the table editor in the Indobase dashboard.
...
- You can use the [Auth logs explorer](https://studio.indobase.in/project/_/logs/auth-logs) to find the issue with more information
- You can use the [Postgres logs explorer](https://studio.indobase.in/project/_/logs/postgres-logs)
