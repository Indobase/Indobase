...
This guide is for identifying configuration mistakes in [self-hosted Indobase Grafana installations](/docs/guides/monitoring-troubleshooting/metrics#deploying-supabase-grafana)
...
```sh
curl https://<YOUR_PROJECT_REF>.indobase.in/customer/v1/privileged/metrics --user 'service_role:<SECRET_API_KEY>'
```
