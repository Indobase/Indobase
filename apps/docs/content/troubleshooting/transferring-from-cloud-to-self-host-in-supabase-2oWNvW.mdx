---
title = "Transferring from platform to self-hosted Indobase"
...
For a detailed, step-by-step guide on restoring your database from the Indobase platform to a [self-hosted Indobase](/docs/guides/self-hosting) instance, see [Restore a Platform Project to Self-Hosted](/docs/guides/self-hosting/restore-from-platform).
