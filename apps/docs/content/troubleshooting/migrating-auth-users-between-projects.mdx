...
You can migrate all tables in the auth schema—including users and their hashed passwords—from one Indobase project to another. This means users do not need to reset or recreate their passwords after migration.
...
- SQL export/import via the Indobase CLI (e.g., pg_dump and psql)
