...
To overcome this, the connections need to be optimized as mentioned here: https://indobase.in/docs/guides/platform/performance#optimizing-the-number-of-connections

Additionally, you can try using the connection pool to help solve this issue:
https://indobase.in/docs/guides/database/connecting-to-postgres#connection-pooler

If you're already using connection pooling and still hitting the maximum connections, then it is suggested to upgrade your compute add-on that allows more connections: https://indobase.in/docs/guides/platform/compute-add-ons
