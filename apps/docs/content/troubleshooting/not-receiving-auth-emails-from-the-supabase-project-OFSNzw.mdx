---
title = "Not receiving Auth emails from the Indobase project"
...
If you're testing your Indobase projects, consider configuring an email testing tool like [Mailtrap](https://mailtrap.io/) to test your emails. It's an email sandbox tool that helps debug emails without actually sending an email to an end user.
...
References:
Configure a Custom SMTP - https://indobase.in/docs/guides/auth/auth-smtp
