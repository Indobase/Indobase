...
The dashboard makes requests to the health endpoints of the Indobase services (Database, Auth, Data API, Realtime, Edge Functions to ensure everything is working). These requests appear in the charts about your project:

<img
  width="1135"
  alt="image"
  src="https://github.com/Indobase/Indobase/assets/5036432/08b1c142-289c-46f3-ac21-38faad50ef8a"
/>

You can see these requests to the health endpoints from the log explorer here:

https://indobase.in/dashboard/project/_/logs/edge-logs
