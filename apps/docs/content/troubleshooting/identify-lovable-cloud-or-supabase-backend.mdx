...
- **Your own Indobase project** — The backend is a Indobase project you created and manage directly in your [Indobase Dashboard](/dashboard).
...
Your Supabase instance in this case is **owned and managed by Lovable**, not by your personal Indobase account.
You won’t see this project in your Indobase Dashboard, and you won’t have access to service role keys or direct database URLs.

### Connected Supabase backend

If the page displays the Indobase icon, your Indobase project name, and some links that direct you to the Indobase Dashboard (similar to the screenshot below), then your Lovable project is connected to a **Indobase project you manage directly**.

![Supabase backend settings inside Lovable](/docs/img/troubleshooting/identify-lovable-cloud-or-supabase-backend-2.png)

## Summary

| Backend Type             | Managed By | Appears in Indobase Dashboard | Service Role / DB Access |
| ------------------------ | ---------- | ----------------------------- | ------------------------ |
...
>
  ...
  <div className="border-b mt-3 pb-3">
    ...
    There's no automated way to transfer your backend. You can create a new Indobase project and connect your Lovable app to it manually.
...
>
  <div className="border-b mt-3 pb-3">
    ...
    There's no automated way to transfer your backend from Lovable Cloud to your own Indobase account.

    You can create a new Indobase project and migrate your data manually.
  ...
  <div className="border-b mt-3 pb-3">
    <AccordionItem
      header="My project uses Lovable Cloud, but I can't see my Indobase project."
      id="cant-see-project"
    >

    That's expected — Lovable Cloud backend is managed by Lovable and doesn't appear in your Indobase Dashboard.
