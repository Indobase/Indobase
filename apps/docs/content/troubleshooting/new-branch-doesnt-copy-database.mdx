...
- If you do not have a local environment set up already, follow the Indobase local development getting started guide:
...
Upon running the above command, the Indobase CLI will typically prompt with:
