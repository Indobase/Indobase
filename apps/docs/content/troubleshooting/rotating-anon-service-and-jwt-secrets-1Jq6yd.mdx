...
Whatever the reason, here's how to rotate the keys for your Indobase project.

If you haven’t migrated to asymmetric JWT signing keys:

{/* supa-mdx-lint-disable Rule004ExcludeWords */}

1. Go to [**Project Settings** → **JWT Keys**](/dashboard/project/_/settings/jwt) in the Indobase Dashboard
...
1. Go to [**Project Settings** → **JWT Keys**](/dashboard/project/_/settings/jwt)s in the Indobase Dashboard
