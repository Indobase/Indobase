...
The process to change the region of an Indobase Project is to create a new project in the desired region and migrate your existing project the [migrations guide](/docs/guides/platform/migrating-within-supabase).
