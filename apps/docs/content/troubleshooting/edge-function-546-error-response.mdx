...
Use the Indobase CLI to run your function locally and get detailed stack traces:
...
Compare your function against working examples in the [Edge Functions examples repository](https://github.com/Indobase/Indobase/tree/master/examples/edge-functions).
