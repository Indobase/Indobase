...
- **Network issues:** Problems reaching the Indobase API during deployment

## Before opening a support ticket

Make sure you're using the latest version of the Indobase CLI:
...
If these steps don't resolve the issue, open a support ticket via the Indobase Dashboard and include all output from the diagnostic commands.
