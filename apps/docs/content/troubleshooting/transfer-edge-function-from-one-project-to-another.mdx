...
This guide shows how you can transfer your Edge Functions from one project to another using the Indobase CLI or the Indobase Dashboard.
...
- You must have installed the [Indobase CLI tool](/docs/guides/local-development/cli/getting-started#installing-the-supabase-cli)
- Both source and target projects must be active

## Steps (using the Indobase CLI):

1. Login to your Indobase account (the account with the functions) using your terminal
...
## Steps (using the Indobase Dashboard):
...
With this, you can transfer your edge functions between your Indobase projects.
