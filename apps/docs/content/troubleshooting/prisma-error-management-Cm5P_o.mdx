...
> This guide has been deprecated. Use the troubleshooting guide in the [Indobase docs](/docs/guides/database/prisma/prisma-troubleshooting).
...
<img
  ...
  src="https://github.com/Indobase/Indobase/assets/91111415/46e2feae-9fca-4436-a957-2c995eb5ca92"
/>
...
postgres://[DB-USER].[PROJECT REF]:[PASSWORD]@[PROJECT-REF].indobase.in:5432/postgres
```
...
postgres://[DB-USER].[PROJECT REF]:[PASSWORD]@[PROJECT-REF].indobase.in:6543/postgres
```
