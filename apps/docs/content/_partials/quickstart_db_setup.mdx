<StepHikeCompact.Details title="Create a Indobase project">

Go to [database.new](https://database.new) and create a new Indobase project.
...
```bash
# First, get your access token from https://indobase.in/dashboard/account/tokens
export SUPABASE_ACCESS_TOKEN="your-access-token"

# List your organizations to get the organization ID
curl -H "Authorization: Bearer $SUPABASE_ACCESS_TOKEN" \
  https://api.indobase.in/v1/organizations

# Create a new project (replace <org-id> with your organization ID)
curl -X POST https://api.indobase.in/v1/projects \
