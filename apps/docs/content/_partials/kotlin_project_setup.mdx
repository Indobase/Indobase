...
1. [Create a new project](https://studio.indobase.in) in the Indobase Dashboard.
...
1. Go to the [SQL Editor](https://studio.indobase.in/project/_/sql) page in the Dashboard.
...
In your [Indobase Auth settings](https://studio.indobase.in/project/_/auth/providers) enable Google as a provider and set the required credentials as outlined in the [auth docs](/docs/guides/auth/social-login/auth-google).
