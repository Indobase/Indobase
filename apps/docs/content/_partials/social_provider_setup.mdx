The next step requires a callback URL, which looks like this: `https://<project-ref>.indobase.in/auth/v1/callback`
...
When testing OAuth locally with the Indobase CLI, ensure your OAuth provider
is configured with the local Indobase Auth callback URL:
...
For testing OAuth locally with the Indobase CLI see the [local development docs](/docs/guides/local-development).
