...
>
    ...
    Every Indobase project exposes a metrics feed at `https://<project-ref>.indobase.in/customer/v1/privileged/metrics`. Replace `<project-ref>` with the identifier from your project URL or from the dashboard sidebar.
    ...
    "https://api.indobase.in/v1/projects/$PROJECT_REF/api-keys?reveal=true"
    ```
