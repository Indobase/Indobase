  ...
  <div className="grid grid-cols-12 gap-6 not-prose">
    {[
      ...
      },
      {
        ...
        description: 'Use the Indobase CLI to develop locally and collaborate between teams.',
      }
    ].map((resource) => {
      return (
        <Link
  ...
  {[
    {
      ...
      description:
        'Learn how to create a Indobase project, add some sample data to your database, and query the data from a React app.',
    ...
    },
    {
      ...
      description:
        'Learn how to create a Indobase project, add some sample data to your database, and query the data from a Next.js app.',
      icon: '/docs/img/icons/nextjs-icon',
      hasLightIcon: true,
      enabled: isFeatureEnabled('docs:framework_quickstarts'),
    },
    {
      ...
      description:
        'Learn how to create a Indobase project, add some sample data to your database, and query the data from a Nuxt app.',
    ...
    },
    {
      ...
      description:
        'Learn how to create a Indobase project, add some sample data to your database, secure it with auth, and query the data from a Hono app.',
    ...
    },
    {
      ...
      description:
        'Learn how to create a Indobase project, add some sample data to your database using Prisma migration and seeds, and query the data from a RedwoodJS app.',
    ...
    },
    {
      ...
      description:
        'Learn how to create a Indobase project, add some sample data to your database, and query the data from a Flutter app.',
    ...
    },
    {
      ...
      description:
        'Learn how to create a Indobase project, add some sample data to your database, and query the data from an iOS app.',
    ...
    },
    {
      ...
      description:
        'Learn how to create a Indobase project, add some sample data to your database, and query the data from an Android Kotlin app.',
    ...
    },
    {
      ...
      description:
        'Learn how to create a Indobase project, add some sample data to your database, and query the data from a SvelteKit app.',
    ...
    },
    {
      ...
      description:
        'Learn how to create a Indobase project, add some sample data to your database, and query the data from a SolidJS app.',
    ...
    },
    {
      ...
      description:
        'Learn how to create a Indobase project, add some sample data to your database, and query the data from a Vue app.',
    ...
    },
    {
      ...
      description:
        'Learn how to create a Indobase project, add some sample data to your database, and query the data from a TanStack Start app.',
    ...
    },
    {
      ...
      description:
        'Learn how to create a Indobase project, add some sample data to your database, and query the data from a Refine app.',
