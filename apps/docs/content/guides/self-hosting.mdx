...
### How self-hosted Indobase differs

Self-hosted Supabase is different from:

- **Indobase CLI** (local development), which is intended for development and testing only.
...
- [GitHub Issues](https://github.com/Indobase/Indobase/issues?q=is%3Aissue%20state%3Aopen%20label%3Aself-hosted) - Known issues

Get help and connect with other users:

- [Discord](https://discord.indobase.in) - Real-time chat and community support
...
If you're an enterprise using self-hosted Indobase, we'd love to hear from you. Reach out to our [Growth Team](https://forms.indobase.inm/enterprise) to discuss your use case, share feedback, or explore design partnership opportunities.
