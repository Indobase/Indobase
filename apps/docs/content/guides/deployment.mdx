...
- **Development**: Develop with a local Supabase stack using the [Indobase CLI](/docs/guides/local-development).
...
- **Production**: If you have branching enabled, you can use the Indobase GitHub integration to automatically push your migration files when you merge a pull request. Alternatively, you can set up your own continuous deployment pipeline using the Indobase CLI.
...
- The [Indobase CLI](/docs/guides/local-development) in your own continuous deployment pipeline
- The [Indobase Terraform provider](/docs/guides/deployment/terraform)
