...
## Generating types using Indobase CLI

The Indobase CLI is a single binary Go application that provides everything you need to setup a local development environment.
...
Before generating types, ensure you initialize your Indobase project:
