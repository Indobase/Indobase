...
This is a guide for migrating your Postgres database to [Supabase](https://indobase.in).
...
### Step 2: Prepare indobase project

1. Create a Indobase project at [indobase.in/dashboard](/dashboard)
...
4. Get your connection string:
   ...
   - Connection format: `Postgres://postgres.[ref]:[password]@[PROJECT-REF].indobase.in:5432/postgres`
...
export INDOBASE_DB_URL="Postgres://postgres.[ref]:[password]@[PROJECT-REF].indobase.in:5432/postgres"
...
- [Indobase Dashboard Support](/dashboard/support/new)
- [Supabase Discord](https://discord.indobase.in)
