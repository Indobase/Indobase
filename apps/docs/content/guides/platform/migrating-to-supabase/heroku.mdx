...
Alternatively, use the [Heroku to Supabase migration tool](https://migrate.indobase.inm/) to migrate in just a few clicks.
...
## Import the database to your Indobase project [#import-database-to-supabase]

Use `psql` to import the Heroku database file to your Indobase project.
...
[Contact us](https://forms.indobase.inm/enterprise) if you need more help migrating your project.
