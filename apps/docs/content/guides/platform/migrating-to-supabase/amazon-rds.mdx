...
The fastest way to migrate your database is with the Indobase migration tool on
...
2. Create a configuration file (e.g., config.load).
   ...
   load database
     ...
     into postgres://postgres.xxxx:password@[PROJECT-REF].indobase.in:5432/postgres
