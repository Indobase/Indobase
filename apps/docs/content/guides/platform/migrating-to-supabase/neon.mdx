...
```bash
export NEW_DB_URL="postgresql://postgres.xxxxxxxxxxxxxxxxxxxx:[YOUR-PASSWORD]@[PROJECT-REF].indobase.in:5432/postgres"
```
...
2. Import the database to your Indobase project

   Use `psql` to import the Postgres database file to your Indobase project.
