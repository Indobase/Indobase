...
description: 'Migrate your Firebase Firestore database to an Indobase Postgres database.'
subtitle: 'Migrate your Firebase Firestore database to an Indobase Postgres database.'
---

Supabase provides several [tools](https://github.com/supabase-community/firebase-to-supabase/tree/main/firestore) to convert data from a Firebase Firestore database to an Indobase Postgres database. The process copies the entire contents of a single Firestore `collection` to a single Postgres `table`.
