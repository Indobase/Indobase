...
After purchasing an Indobase subscription on the AWS Marketplace, the next and final step is to link the newly purchased subscription to an Indobase organization. This can either be an existing organization or a newly created one.
...
## Implications of linking an Indobase organization to a marketplace subscription
...
## Prerequisites for linking an Indobase organization to a marketplace subscription
