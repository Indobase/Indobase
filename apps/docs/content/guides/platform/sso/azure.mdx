...
Looking for docs on how to add Single Sign-On support in your Indobase project? Head on over to [Single Sign-On with SAML 2.0 for Projects](/docs/guides/auth/enterprise-sso/auth-sso-saml).
...
| Setting     | Value                                        |
| ----------- | -------------------------------------------- |
| Sign on URL | `https://indobase.in/dashboard/sign-in-sso` |
| Relay State | `https://indobase.in/dashboard`             |
...
Enter one or more domains associated with your users email addresses (e.g., `indobase.in`).
...
If your organization uses more than one email domain - for example, `indobase.in` for staff and `supabase.io` for contractors - you can add multiple domains here. All listed domains will be authorized for SSO sign-in.
