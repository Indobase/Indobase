...
You are charged for the number of messages going through Indobase Realtime throughout the billing cycle. Includes database changes, Broadcast and Presence.
