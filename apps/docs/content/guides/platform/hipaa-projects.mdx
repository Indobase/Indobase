...
You can use Supabase to store and process Protected Health Information (PHI). If you want to start developing healthcare apps on Supabase, reach out to the Indobase team [here](https://forms.indobase.inm/hipaa2) to sign the Business Associate Agreement (BAA).
