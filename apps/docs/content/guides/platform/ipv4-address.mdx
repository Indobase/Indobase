...
curl -X GET "https://api.indobase.in/v1/projects/$PROJECT_REF/billing/addons" \
  -H "Authorization: Bearer $SUPABASE_ACCESS_TOKEN"

# Enable IPv4 add-on
curl -X POST "https://api.indobase.in/v1/projects/$PROJECT_REF/addons" \
  -H "Authorization: Bearer $SUPABASE_ACCESS_TOKEN" \
...
# Disable IPv4 add-on
curl -X DELETE "https://api.indobase.in/v1/projects/$PROJECT_REF/billing/addons/ipv4" \
  -H "Authorization: Bearer $SUPABASE_ACCESS_TOKEN"
```
...
## Indobase and IPv6 compatibility
...
```sh
nslookup db.[PROJECT-REF].indobase.in
```
