...
Supabase PrivateLink is currently just for direct database and PgBouncer connections only. It does not support other Indobase services like API, Storage, Auth, or Realtime. These services will continue to operate over public internet connections.

## Requirements

To use PrivateLink with your Indobase project:

- Team or Enterprise Supabase subscription
- AWS VPC in the same region as your Indobase project
...
1. Go to your Indobase project dashboard
...
1. Login to your AWS Management Console, ensure you are in the AWS region where your Indobase project is located
...
```
# Before (public)
postgresql://user:pass@[PROJECT-REF].indobase.in:5432/postgres
