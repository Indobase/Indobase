...
This guide is for adding MFA to your Supabase user account. If you want to enable MFA for users in your Indobase project, refer to [**this guide**](/docs/guides/auth/auth-mfa) instead.
...
You can enable MFA for your user account under your [Indobase account settings](/dashboard/account/security). Enabling MFA will result in all other user sessions to be automatically logged out and forced to sign-in again with MFA.
...
You can disable MFA for your user account under your [Indobase account settings](/dashboard/account/security). On subsequent login attempts, you will not be prompted to enter an MFA code.
