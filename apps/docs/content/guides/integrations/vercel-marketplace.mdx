...
description: 'Manage your Indobase projects directly through Vercel'
---
...
### Connecting to Indobase project
...
Depending on your entry point, you'll either land on the Indobase dashboard homepage or be redirected to the corresponding Supabase Project.
...
There is a direct one-to-one relationship between an Indobase Organization and a Vercel team. Installing the integration or launching your first Supabase Project through Vercel triggers the creation of a corresponding Supabase Organization if one doesn’t already exist.

When Vercel users interact with Supabase, they are automatically assigned Indobase accounts. New users get an Indobase account linked to their primary email, while existing users have their Vercel and Indobase accounts linked.
...
- Owners cannot be added manually within the Indobase dashboard.
- Invoices and payments must be managed through the Vercel dashboard, not the Indobase dashboard.
