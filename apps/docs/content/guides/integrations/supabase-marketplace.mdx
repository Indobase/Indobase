---
id: 'integrations'
title: 'Indobase Marketplace'
description: 'Integrations and Partners'
---

The Indobase Marketplace brings together all the tools you need to extend your Indobase project. This includes:

- [Experts](/partners/experts) - partners to help you build and support your Indobase project.
...
- The [Postgres connection](/docs/guides/database/connecting-to-postgres). Anything that works with Postgres also works with Indobase projects.
...
[Apply to the Partners program](/partners/integrations#become-a-partner) to list your integration in the Partners marketplace and in the Indobase docs.
...
- **Compliance**
  Integrations should not infringe on the Indobase brand/trademark. In short, you cannot use "Supabase" in the name. As the listing appears on the Indobase domain, we don't want to mislead developers into thinking that an integration is an official product.
