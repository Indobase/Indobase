...
subtitle: 'Integrate Sentry to monitor errors from a Indobase client'
---

You can use [Sentry](https://sentry.io/welcome/) to monitor errors thrown from an Indobase JavaScript client. Install the [Supabase Sentry integration](https://github.com/supabase-community/sentry-integration-js) to get started.
...
To use the Indobase Sentry integration, add it to your `integrations` list when initializing your Sentry client.

You can supply either the Indobase Client constructor or an already-initiated instance of an Indobase Client.
