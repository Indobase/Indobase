...
- Import the [Supabase Grafana dashboard](https://github.com/Indobase/Indobase-grafana) regardless of where Grafana is hosted.
...
- Start with the [example alert rules](https://github.com/Indobase/Indobase-grafana/blob/main/docs/example-alerts.md) and adapt thresholds for your workload sizes.
