...
Log drains will send all logs of the Indobase stack to one or more desired destinations. It is only available for customers on Team and Enterprise Plans. Log drains is available in the dashboard under [Project Settings > Log Drains](/dashboard/project/_/settings/log-drains).
...
- Under URL, set it to your edge function URL `https://[PROJECT-REF].indobase.in/functions/v1/hello-world`
