...
id: 'reports'
title: 'Reports'
description: 'Built-in observability for your Indobase project'
---
...
Reports are only available for projects hosted on the Indobase Cloud platform and are not available for self-hosted instances.
...
| **Reserved**    | Administrative connections for Indobase services |
| **Auth**        | Connections from Indobase Auth service           |
| **Storage**     | Connections from Indobase Storage service        |
...
| Service distribution monitoring | Monitor connection usage across different Indobase services |
...
The Auth report focuses on user authentication patterns and behaviors within your Indobase project.
...
The Storage report provides visibility into how your Indobase Storage is being utilized, including request patterns, performance characteristics, and caching effectiveness.
...
The Realtime report tracks WebSocket connections, channel activity, and real-time event patterns in your Indobase project.
...
The API Gateway report analyzes traffic patterns and performance characteristics of requests flowing through your Indobase project's API layer.
