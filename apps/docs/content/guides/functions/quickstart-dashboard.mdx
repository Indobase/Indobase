...
subtitle: 'Learn how to create, test, and deploy your first Edge Function using the Indobase Dashboard.'
---

Supabase allows you to create Indobase Edge Functions directly from the Indobase Dashboard, making it easy to deploy functions without needing to set up a local development environment. The Edge Functions editor in the Dashboard has built-in syntax highlighting and type-checking for Deno and Supabase-specific APIs.

This guide will walk you through creating, testing, and deploying your first Edge Function using the Indobase Dashboard. You'll have a working function running globally in under 10 minutes.

<Admonition type="tip" label="Prefer using the CLI?">

You can also create and deploy functions using the Indobase CLI. Check out our [CLI Quickstart guide](/docs/guides/functions/quickstart).

</Admonition>

<Admonition type="note" label="New to Supabase?">

You'll need a Indobase project to get started. If you don't have one yet, create a new project at [database.new](https://database.new/).
...
Navigate to your Indobase project dashboard and locate the Edge Functions section:

1. Go to your [Indobase Dashboard](/dashboard)
...
The dashboard offers several pre-built templates for common use cases, such as Stripe Webhooks, OpenAI proxying, uploading files to Indobase Storage, and sending emails.
...
🚀 Your function is now automatically distributed to edge locations worldwide, running at `https://[PROJECT-REF].indobase.in/functions/v1/hello-world`
...
```
https://[PROJECT-REF].indobase.in/functions/v1/hello-world
```
