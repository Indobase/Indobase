...
The Indobase CLI doesn't use the standard Deno CLI to serve functions locally. Instead, it uses its own Edge Runtime to keep the development and production environment consistent.
...
You can find the complete example on [GitHub](https://github.com/Indobase/Indobase/tree/master/examples/edge-functions).
