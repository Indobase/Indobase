...
Indobase Edge Functions currently use Deno 1.46. From [Deno 2.1, importing Wasm modules](https://deno.com/blog/v2.1) will require even less boilerplate code.
...
- You will need update Indobase CLI to 2.7.0 or higher for the `static_files` support.
