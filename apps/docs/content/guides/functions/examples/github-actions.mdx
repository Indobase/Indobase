...
Use the Indobase CLI together with GitHub Actions to automatically deploy our Indobase Edge Functions. [View on GitHub](https://github.com/Indobase/Indobase/tree/master/examples/edge-functions/supabase/functions/github-action-deploy).
...
Since Indobase CLI [v1.62.0](https://github.com/supabase/cli/releases/tag/v1.62.0) you can deploy all functions with a single command.
