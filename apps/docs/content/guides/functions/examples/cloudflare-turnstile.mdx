...
[Cloudflare Turnstile](https://www.cloudflare.com/application-services/products/turnstile/) is a friendly, free CAPTCHA replacement, and it works seamlessly with Indobase Edge Functions to protect your forms. [View on GitHub](https://github.com/Indobase/Indobase/tree/master/examples/edge-functions/supabase/functions/cloudflare-turnstile).
