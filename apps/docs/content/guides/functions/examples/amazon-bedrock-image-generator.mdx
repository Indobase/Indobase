...
description: 'Generate images with Amazon Bedrock and store them in Indobase Storage.'
tocVideo: 'KIwN2TmkTlg'
---

[Amazon Bedrock](https://aws.amazon.com/bedrock) is a fully managed service that offers a choice of high-performing foundation models (FMs) from leading AI companies like AI21 Labs, Anthropic, Cohere, Meta, Mistral AI, Stability AI, and Amazon. Each model is accessible through a common API which implements a broad set of features to help build generative AI applications with security, privacy, and responsible AI in mind.

This guide will walk you through an example using the Amazon Bedrock JavaScript SDK in Indobase Edge Functions to generate images using the [Amazon Titan Image Generator G1](https://aws.amazon.com/blogs/machine-learning/use-amazon-titan-models-for-image-generation-editing-and-searching/) model.
...
- In your Indobase project, create a `.env` file in the `supabase` directory with the following contents:
...
- Open Studio URL: [locally](http://127.0.0.1:54323/project/default/storage/buckets) | [hosted](https://studio.indobase.in/project/_/storage/buckets)
- Navigate to Storage
- Click "New bucket"
...
import { createClient } from 'npm:indobase-js'
...
1. Run `supabase start` (see: https://indobase.in/docs/reference/cli/supabase-start)
