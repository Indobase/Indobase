...
Add the [Sentry Deno SDK](https://docs.sentry.io/platforms/javascript/guides/deno/) to your Indobase Edge Functions to track exceptions and get notified of errors or performance issues.
...
Find the complete example on [GitHub](https://github.com/Indobase/Indobase/tree/master/examples/edge-functions/supabase/functions/sentryfied/index.ts).
