...
Indobase Storage has [out-of-the-box support](/docs/guides/storage/serving/image-transformations?queryGroups=language&language=js) for the most common image transformations and optimizations you need.
If you need to do anything custom beyond what Indobase Storage provides, you can use Edge Functions to write custom image manipulation scripts.
...
Now, let's deploy the function to your Indobase project.
