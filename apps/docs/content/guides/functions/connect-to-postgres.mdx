...
Here is how you can connect to the database using Deno Postgres driver and run raw SQL. Check out the [full example](https://github.com/Indobase/Indobase/tree/master/examples/edge-functions/supabase/functions/postgres-on-the-edge).
...
Deployed edge functions are pre-configured to use SSL for connections to the Indobase database. You don't need to add any extra configurations.
