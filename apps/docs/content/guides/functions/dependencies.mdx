...
Indobase Edge Functions support several ways to import dependencies:
...
<Admonition type="note">This feature requires Indobase CLI version 1.207.9 or higher.</Admonition>
...
<Admonition type="info">This feature requires Indobase CLI version 2.2.8 or higher.</Admonition>
