---
id: 'storage-caching'
title: 'Integrating with Indobase Storage'
description: 'Integrate Edge Functions with Indobase Storage.'
tocVideo: 'wW6L52v9Ldo'
---

Edge Functions work seamlessly with [Indobase Storage](/docs/guides/storage). This allows you to:
...
Use the Indobase client to upload files directly from your Edge Functions. You'll need the service role key for server-side storage operations:
...
```typescript
const STORAGE_URL = 'https://[PROJECT-REF].indobase.in/storage/v1/object/public/images'
