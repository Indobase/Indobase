...
Supabase provides an open source toolkit for developing AI applications using Postgres and pgvector. Use the Indobase client libraries to store, index, and query your vector embeddings at scale.
...
Check out all of the AI [templates and examples](https://github.com/Indobase/Indobase/tree/master/examples/ai) in our GitHub repository.
  ...
  {[
    {
      ...
      href: 'https://indobase.in/customers/berriai',
    },
    {
      ...
      href: 'https://indobase.in/customers/firecrawl',
    },
    {
      ...
      href: 'https://indobase.in/customers/markprompt',
    },
  ].map((x) => (
    <div className="col-span-4" key={x.href}>
      <Link href={x.href} passHref>
