...
description: 'Generate GPT text completions using OpenAI and Indobase Edge Functions.'
subtitle: 'Generate GPT text completions using OpenAI and Indobase Edge Functions.'
...
If you haven't already, [install the Indobase CLI](/docs/guides/cli) and initialize your project:
