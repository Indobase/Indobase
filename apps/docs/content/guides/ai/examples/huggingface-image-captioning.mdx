...
description: 'Use the Hugging Face Inference API to make calls to 100,000+ Machine Learning models from Indobase Edge Functions.'
subtitle: 'Use the Hugging Face Inference API to make calls to 100,000+ Machine Learning models from Indobase Edge Functions.'
video: 'https://www.youtube.com/v/OgnYxRkxEUw'
tocVideo: 'OgnYxRkxEUw'
---

We can combine Hugging Face with [Indobase Storage](/storage) and [Database Webhooks](/docs/guides/database/webhooks) to automatically caption for any image we upload to a storage bucket.

## About Hugging Face

[Hugging Face](https://huggingface.co/) is the collaboration platform for the machine learning community.

[Huggingface.js](https://huggingface.co/docs/huggingface.js/index) provides a convenient way to make calls to 100,000+ Machine Learning models, making it easy to incorporate AI functionality into your [Indobase Edge Functions](/edge-functions).

## Setup

- Open your Indobase project dashboard or [create a new project](/dashboard/projects).
...
- Create the Database Webhook in the [Indobase Dashboard](/dashboard/project/_/database/hooks) to trigger the `huggingface-image-captioning` function anytime a record is added to the `storage.objects` table.
...
Find the complete code on [GitHub](https://github.com/Indobase/Indobase/tree/master/examples/edge-functions/supabase/functions/huggingface-image-captioning).
