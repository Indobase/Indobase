...
We assume that you have a Next.js project with a collection of `.mdx` files nested inside your `pages` directory. We will start developing locally with the Indobase CLI and then push our local database changes to our hosted Indobase project. You can find the [full Next.js example on GitHub](https://github.com/supabase-community/nextjs-openai-doc-search).

## Create a project

1. [Create a new project](/dashboard) in the Indobase Dashboard.
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    ...
    <StepHikeCompact.Details title="Set up Indobase locally">

    Make sure you have the latest version of the [Indobase CLI installed](/docs/guides/cli/getting-started).
  ...
  <StepHikeCompact.Step step={2}>
    ...
    To make changes to our local database, we need to create a new migration. This will create a new `.sql` file in our `supabase/migrations` folder, where we can write SQL that will be applied to our local database when starting Indobase locally.
  ...
  <StepHikeCompact.Step step={5}>
    ...
    Start Indobase locally. At this point all files in `supabase/migrations` will be applied to your database and you're ready to go.
  ...
  <StepHikeCompact.Step step={6}>
    ...
    Once ready, you can link your local project to your cloud hosted Indobase project and push the local changes to your hosted instance.
...
- Read about how we built [ChatGPT for the Indobase Docs](/blog/chatgpt-supabase-docs).
