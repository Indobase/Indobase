...
You can find the full application code as a Python Poetry project on [GitHub](https://github.com/Indobase/Indobase/tree/master/examples/ai/image_search#image-search-with-supabase-vector).
...
## Setup Indobase project

If you haven't already, [install the Indobase CLI](/docs/guides/cli), then initialize Supabase in the root of your newly created poetry project:
...
This will start up the Indobase stack locally and print out a bunch of environment details, including your local `DB URL`. Make a note of that for later user.
...
In the root of your project, create a new folder called `images` and add some images. You can use the images from the example project on [GitHub](https://github.com/Indobase/Indobase/tree/master/examples/ai/image_search/images) or you can find license free images on [Unsplash](https://unsplash.com).
