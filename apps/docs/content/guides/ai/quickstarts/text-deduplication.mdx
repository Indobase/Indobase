...
This guide will walk you through a ["Semantic Text Deduplication"](https://github.com/Indobase/Indobase/blob/master/examples/ai/semantic_text_deduplication.ipynb) example using Colab and Supabase Vecs. You'll learn how to find similar movie reviews using embeddings, and remove any that seem like duplicates. You will:
...
Launch our [`semantic_text_deduplication`](https://github.com/Indobase/Indobase/blob/master/examples/ai/semantic_text_deduplication.ipynb) notebook in Colab:
