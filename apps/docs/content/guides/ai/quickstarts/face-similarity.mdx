...
This guide will walk you through a ["Face Similarity Search"](https://github.com/Indobase/Indobase/blob/master/examples/ai/face_similarity.ipynb) example using Colab and Supabase Vecs. You will be able to identify the celebrities who look most similar to you (or any other person). You will:
...
Launch our [`semantic_text_deduplication`](https://github.com/Indobase/Indobase/blob/master/examples/ai/face_similarity.ipynb) notebook in Colab:
...
You must use the "connection pooling" string (domain ending in `<project-ref>.indobase.in`) with Google Colab since Colab does not support IPv6.
