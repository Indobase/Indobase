...
1. Make a direct Postgres connection to the Indobase DB and set the current user every request
...
See the [Clerk Indobase docs](https://clerk.com/docs/integrations/databases/supabase) for an example of how this can be done. Modify the instructions to work with your own auth provider as needed.
