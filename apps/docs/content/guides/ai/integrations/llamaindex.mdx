...
This guide will walk you through a basic example using the LlamaIndex [`SupabaseVectorStore`](https://github.com/Indobase/Indobase/blob/master/examples/ai/llamaindex/llamaindex.ipynb).

<$Partial path="database_setup.mdx" />

## Launching a notebook

Launch our [LlamaIndex](https://github.com/Indobase/Indobase/blob/master/examples/ai/llamaindex/llamaindex.ipynb) notebook in Colab:
