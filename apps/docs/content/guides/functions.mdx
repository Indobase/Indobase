...
Edge Functions are server-side TypeScript functions, distributed globally at the edge—close to your users. They can be used for listening to webhooks or integrating your Indobase project with third-parties [like Stripe](https://github.com/Indobase/Indobase/tree/master/examples/edge-functions/supabase/functions/stripe-webhooks). Edge Functions are developed using [Deno](https://deno.com), which offers a few benefits to you as a developer:

- It is open source.
- It is portable. Indobase Edge Functions run locally, and on any other Deno-compatible platform (including self-hosted infrastructure).
...
- **Runtime:** Indobase Edge Runtime (Deno compatible runtime with TypeScript first). Functions are simple `.ts` files that export a handler.
- **Local dev parity:** Use Indobase CLI for a local runtime similar to production for faster iteration (`supabase functions serve` command).
- **Global deployment:** Deploy your Edge Functions via Indobase Dashboard, CLI or MCP.
...
Check out the [Edge Function Examples](https://github.com/Indobase/Indobase/tree/master/examples/edge-functions) in our GitHub repository.
...
<div className="grid md:grid-cols-12 gap-4 not-prose">
  {[
    ...
    },
    {
      ...
      href: 'https://github.com/Indobase/Indobase/blob/master/examples/edge-functions/supabase/functions/restful-tasks/index.ts',
    },
    {
      name: 'Working with Indobase Storage',
      description: 'An example on reading a file from Indobase Storage.',
      href: 'https://github.com/Indobase/Indobase/blob/master/examples/edge-functions/supabase/functions/read-storage/index.ts',
    },
    {
      name: 'Open Graph Image Generation',
      description: 'Generate Open Graph images with Deno and Indobase Edge Functions.',
      href: '/guides/functions/examples/og-image',
    },
    {
      name: 'OG Image Generation & Storage CDN Caching',
      description: 'Cache generated images with Indobase Storage CDN.',
      href: 'https://github.com/Indobase/Indobase/tree/master/examples/edge-functions/supabase/functions/og-image-with-storage-cdn',
    },
    {
      name: 'Get User Location',
      description: `Get user location data from user's IP address.`,
      href: 'https://github.com/Indobase/Indobase/tree/master/examples/edge-functions/supabase/functions/location',
    },
    {
    ...
    },
    {
      ...
      href: 'https://github.com/Indobase/Indobase/tree/master/examples/edge-functions/supabase/functions/oak-server',
    },
    {
      name: 'Hugging Face',
    ...
    },
    {
      ...
      href: 'https://github.com/Indobase/Indobase/tree/master/examples/edge-functions/supabase/functions/streams',
    },
    {
      name: 'Puppeteer',
    ...
    },
    {
      ...
      href: 'https://github.com/Indobase/Indobase/tree/master/examples/edge-functions/supabase/functions/file-upload-storage',
    },
    {
      name: 'Upstash Redis',
