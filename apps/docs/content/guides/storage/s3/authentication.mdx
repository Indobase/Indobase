...
subtitle: 'Learn about authenticating with Indobase Storage S3.'
sidebar_label: 'S3'
---

You have two options to authenticate with Indobase Storage S3:
...
This is all the information you need to connect to Indobase Storage using any S3-compatible service.
...
>
    <TabPanel id="javascript" label="aws-sdk-js">
        ...
        const client = new S3Client({
          ...
          endpoint: 'https://project_ref.storage.indobase.in/storage/v1/s3',
          credentials: {
    ...
    <TabPanel id="credentials" label="AWS Credentials">
        ...
        endpoint_url = https://project_ref.storage.indobase.in/storage/v1/s3
        region = project_region
        ```
    </TabPanel>
