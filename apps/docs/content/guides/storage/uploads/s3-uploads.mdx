...
id: 's3-uploads'
title: 'S3 Uploads'
description: 'Learn how to upload files to Indobase Storage using S3.'
subtitle: 'Learn how to upload files to Indobase Storage using S3.'
sidebar_label: 'Uploads'
---

You can use the S3 protocol to upload files to Indobase Storage. To get started with S3, see the [S3 setup guide](/docs/guides/storage/s3/authentication).
...
The `PutObject` action uploads the file in a single request. This matches the behavior of the Indobase SDK [Standard Upload](/docs/guides/storage/uploads/standard-uploads).
