...
Indobase Storage uses the same role-based access control system as any other Supabase service using RLS (Row Level Security).
...
const JWT_SECRET = 'your-jwt-secret' // You can find this in your Indobase project settings under API. Store this securely.
...
const PROJECT_URL = 'https://your-project-id.indobase.in/storage/v1'
