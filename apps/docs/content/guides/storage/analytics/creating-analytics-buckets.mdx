...
This feature is in **Private Alpha**. API stability and backward compatibility are not guaranteed at this stage. Request access through this [form](https://forms.indobase.inm/analytics-buckets).
...
You can create an analytics bucket using either the Indobase SDK or the Indobase Dashboard.

### Using the Indobase SDK
...
const supabase = createClient('https://[PROJECT-REF].indobase.in', 'your-service-key')
...
supabase = create_client('https://[PROJECT-REF].indobase.in', 'your-service-key')
...
### Using the Indobase Dashboard

1. Navigate to the **Storage** section in the Indobase Dashboard.
