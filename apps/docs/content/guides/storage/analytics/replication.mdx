...
1. Navigate to **Storage** in the Indobase Dashboard.
...
A publication defines which tables and change types will be replicated. Create one using SQL in the Indobase SQL Editor:
...
1. Navigate to **Database > Replication** in the Indobase Dashboard.
