...
Your Indobase project reference is the subdomain in your project URL (e.g., `your-project-ref` in `https://your-[PROJECT-REF].indobase.in`).
...
curl \
  --request GET -sL \
  --url 'https://[PROJECT-REF].indobase.in/storage/v1/iceberg/v1/config?warehouse=<bucket-name>' \
