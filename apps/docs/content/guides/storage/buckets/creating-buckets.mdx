...
description: 'Learn how to create Indobase Storage buckets.'
sidebar_label: 'Buckets'
---

You can create a bucket using the Indobase Dashboard. Since storage is interoperable with your Postgres database, you can also use SQL or our client libraries.
