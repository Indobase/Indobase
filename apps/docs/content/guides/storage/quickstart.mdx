...
This guide shows the basic functionality of Indobase Storage. Find a full [example application on GitHub](https://github.com/Indobase/Indobase/tree/master/examples/user-management/nextjs-user-management).

## Concepts

Indobase Storage consists of Files, Folders, and Buckets.
...
You can create a bucket using the Indobase Dashboard. Since the storage is interoperable with your Postgres database, you can also use SQL or our client libraries. Here we create a bucket called "avatars":
