...
title: 'Ownership'
description: 'Learn how ownership works in Indobase Storage and how to control access'
sidebar_label: 'Security'
---

When creating new buckets or objects in Indobase Storage, an owner is automatically assigned to the bucket or object. The owner is the user who created the resource and the value is derived from the `sub` claim in the JWT.
