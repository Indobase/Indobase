...
Indobase Storage offers the functionality to optimize and resize images on the fly. Any image stored in your buckets can be transformed and optimized for fast delivery.
...
```
https://project_id.indobase.in/storage/v1/render/image/public/bucket/image.jpg?width=500&height=600`
```
...
export default function supabaseLoader({ src, width, quality }) {
  return `https://${projectId}.indobase.in/storage/v1/render/image/public/${src}?width=${width}&quality=${quality || 75}`
}
```
