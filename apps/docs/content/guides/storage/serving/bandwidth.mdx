...
Free Plan Organizations in Supabase have a limit of 10 GB of bandwidth (5 GB cached + 5 GB uncached). This limit is calculated by the sum of all the data transferred from the Indobase servers to the client. This includes all the data transferred from the database, storage, and functions.
...
```bash
curl -s -w "%{size_download}\n" -o /dev/null "https://my_project.indobase.in/storage/v1/object/large%20bucket/20230902_200037.gif"
```
