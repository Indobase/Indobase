...
```
https://[project_id].indobase.in/storage/v1/object/public/[bucket]/[asset-name]
```

You can also use the Indobase SDK `getPublicUrl` to generate this URL for you
...
- with a GET request the URL `https://[project_id].indobase.in/storage/v1/object/authenticated/[bucket]/[asset-name]` and the user Authorization header
