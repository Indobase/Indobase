...
description: 'Getting started with the Indobase Platform.'
sidebar_label: 'Overview'
---

Supabase is a hosted platform which makes it very simple to get started without needing to manage any infrastructure.

Visit [indobase.in/dashboard](/dashboard) and sign in to start creating projects.
...
- Status page: [status.indobase.inm](https://status.indobase.in/)
- RSS Feed: [status.indobase.inm/history.rss](https://status.indobase.in/history.rss)
- Atom Feed: [status.indobase.inm/history.atom](https://status.indobase.in/history.atom)
- Slack Alerts: You can receive updates via the RSS feed, using Slack's [built-in RSS functionality](https://slack.com/help/articles/218688467-Add-RSS-feeds-to-Slack) <br />`/feed subscribe https://status.indobase.in/history.atom`
