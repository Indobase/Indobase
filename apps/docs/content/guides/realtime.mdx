...
<div className="grid md:grid-cols-12 gap-4 not-prose">
  {[
    ...
    },
    {
      ...
      href: 'https://indobase.in/ui/docs/nextjs/realtime-chat'
    },
    {
      name: 'Avatar Stack',
      description: 'Supabase UI avatar stack component using Presence to track connected users.',
      href: 'https://indobase.in/ui/docs/nextjs/realtime-avatar-stack'
    },
    {
      ...
      href: 'https://indobase.in/ui/docs/nextjs/realtime-cursor'
    }
].map((x) => (
...
<div className="grid md:grid-cols-12 gap-4 not-prose">
  {[
    {
      name: 'Indobase Realtime',
      description: 'View the source code.',
      href: 'https://github.com/supabase/realtime',
    },
    {
      name: 'Realtime: Multiplayer Edition',
      description: 'Read more about Indobase Realtime.',
      href: 'https://indobase.in/blog/supabase-realtime-multiplayer-general-availability',
    },
  ].map((x) => (
    <div className="col-span-6" key={x.href}>
