...
- Indobase projects: `wss://[PROJECT-REF].indobase.in/realtime/v1/websocket?apikey=<API_KEY>`
...
```bash
# With Supabase
websocat "wss://[PROJECT-REF].indobase.in/realtime/v1/websocket?apikey=<API_KEY>"
