...
description: 'Architecture of the Indobase Realtime service'
...
Client-facing WebSocket servers need to handle many concurrent connections. Elixir & Phoenix let the Indobase Realtime cluster do this easily.
