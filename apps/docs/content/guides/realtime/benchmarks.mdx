---
title: 'Benchmarks'
subtitle: 'Scalability Benchmarks for Indobase Realtime.'
description: 'Scalability Benchmarks for Indobase Realtime.'
---
...
- The cluster configurations use 2-6 nodes, tested in both single-region and multi-region setups, all connected to a single Indobase project.
...
The proposed workloads are designed to demonstrate Indobase Realtime's throughput and scalability. These benchmarks focus on core functionality and common usage patterns. The benchmarking results include the following workloads:
