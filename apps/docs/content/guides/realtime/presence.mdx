...
You can use the Indobase client libraries to track Presence state between users.
...
```swift
let supabaseURL = "https://[PROJECT-REF].indobase.in"
...
SUPABASE_URL = 'https://[PROJECT-REF].indobase.in'
