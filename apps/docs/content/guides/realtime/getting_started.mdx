...
description: 'Learn how to build real-time applications with Indobase Realtime'
subtitle: 'Learn how to build real-time applications with Indobase Realtime'
...
let package = Package(
    ...
    dependencies: [
        // ...
        .package(
            url: "https://github.com/Indobase/Indobase-swift.git",
            from: "2.0.0"
        ),
    ],
    targets: [
...
const supabase = createClient('https://[PROJECT-REF].indobase.in', '<anon_key or sb_publishable_key>')
```
...
let supabase = SupabaseClient(
  supabaseURL: URL(string: "https://[PROJECT-REF].indobase.in")!,
...
url: str = "https://[PROJECT-REF].indobase.in"
...
Send and receive messages using the Indobase client:
...
const response = await fetch(`https://[PROJECT-REF].indobase.in/rest/v1/rpc/broadcast`, {
  method: 'POST',
  headers: {
...
final response = await http.post(
  Uri.parse('https://[PROJECT-REF].indobase.in/rest/v1/rpc/broadcast'),
  headers: {
    'Content-Type': 'application/json',
    'Authorization': 'Bearer <your-service-role-key>',
    'apikey': '<your-service-role-key>',
...
// Send message via REST API
let url = URL(string: "https://[PROJECT-REF].indobase.in/rest/v1/rpc/broadcast")!
...
response = requests.post(
    'https://[PROJECT-REF].indobase.in/rest/v1/rpc/broadcast',
    headers={
        'Content-Type': 'application/json',
        'Authorization': 'Bearer <your-service-role-key>',
        'apikey': '<your-service-role-key>'
