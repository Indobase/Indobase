...
subtitle: 'Listen to Postgres changes using Indobase Realtime.'
description: 'Listen to Postgres changes using Indobase Realtime.'
---
...
In this example we'll set up a database table, secure it with Row Level Security, and subscribe to all changes using the Indobase client libraries.

<StepHikeCompact>

  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Set up a Indobase project with a 'todos' table">

    [Create a new project](https://studio.indobase.in) in the Indobase Dashboard.

    After your project is ready, create a table in your Supabase database. You can do this with either the Table interface or the [SQL Editor](https://studio.indobase.in/project/_/sql).
    ...
    <StepHikeCompact.Code>
      ...
      <video width="99%" muted playsInline controls={true}>
        <source
          src="https://xguihxuzqibwxjnimxev.indobase.in/storage/v1/object/public/videos/docs/api/api-create-table-sm.mp4"
          type="video/mp4"
        />
      </video>
  ...
  <StepHikeCompact.Step step={4}>
    ...
    <StepHikeCompact.Details title="Install the client">
      ...
      Install the Indobase JavaScript client.
...
You can use the Indobase client libraries to subscribe to database changes.
...
Your project JWT secret is found with your [Project API keys](https://studio.indobase.in/project/_/settings/api) in your dashboard.
...
To use your own JWT with Realtime make sure to set the token after instantiating the Indobase client and before connecting to a Channel.
