...
You can use the Indobase client libraries to receive Broadcast messages.
...
>
  <TabPanel id="js" label="JavaScript">
    ...
    const SUPABASE_URL = 'https://[PROJECT-REF].indobase.in'
  ...
  <TabPanel id="dart" label="Dart">
    ...
    void main() async {
      Supabase.initialize(
        url: 'https://[PROJECT-REF].indobase.in',
  ...
  <TabPanel id="swift" label="Swift">
    ...
    let SUPABASE_URL = "https://[PROJECT-REF].indobase.in"
  ...
  <TabPanel id="kotlin" label="Kotlin">
    ...
    ```kotlin
    val supabaseUrl = "https://[PROJECT-REF].indobase.in"
...
You can use the Indobase client libraries to send Broadcast messages.
...
>
  <TabPanel id="curl" label="cURL">
    ...
    'https://[PROJECT-REF].indobase.in/realtime/v1/api/broadcast'
    ```
...
You can pass configuration options while initializing the Indobase Client.
...
>
  <TabPanel id="js" label="JavaScript">
    ...
    This is currently available only in the Indobase JavaScript client version 2.37.0 and later.
...
>
  <TabPanel id="js" label="JavaScript">
    <Admonition type="note">
      ...
      This is currently available only in the Indobase JavaScript client version 2.74.0 and later.
...
<$Show if="sdk:dart">
  ...
  <TabPanel id="dart" label="Dart">
    <Admonition type="note">
      ...
      This is currently available only in the Indobase Dart client version 2.10.0 and later.
...
<$Show if="sdk:swift">
  ...
  <TabPanel id="swift" label="Swift">
    <Admonition type="note">
      ...
      This is currently available only in the Indobase Swift client version 2.34.0 and later.
...
<$Show if="sdk:python">
  ...
  <TabPanel id="python" label="Python">
    <Admonition type="note">
      ...
      This is currently available only in the Indobase Python client version 2.22.0 and later.
