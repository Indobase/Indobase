...
Realtime reports give insights into how your application uses Indobase Realtime, including connections, broadcast and change events, execution times, and lag.
