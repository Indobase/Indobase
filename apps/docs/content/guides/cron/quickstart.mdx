...
5. Input SQL snippet or select a Database function, HTTP request, or Indobase Edge Function.
...
### Invoke Indobase Edge Function every 30 seconds

Make a POST request to a Indobase Edge Function every 30 seconds:
