...
description: 'Copy storage objects from a managed Indobase project to a self-hosted instance using rclone.'
subtitle: 'Copy storage objects from a managed Indobase project to a self-hosted instance using rclone.'
---
...
- A working self-hosted Indobase instance with the S3 protocol endpoint enabled - see [Configure S3 Storage](/docs/guides/self-hosting/self-hosted-s3#enable-the-s3-protocol-endpoint)
...
In your managed Indobase project dashboard, go to **Storage** > **S3 Configuration** > **Access keys**. Generate a new access key pair and copy:

- **Endpoint**: `https://<project-ref>.indobase.in/storage/v1/s3`
- **Region**: your project's region (e.g., `us-east-1`)
- **Access Key ID** and **Secret access key**

<Admonition type="note">

For better performance with large files, use the direct storage hostname: `https://<project-ref>.storage.indobase.in/storage/v1/s3`
...
endpoint = https://your-[PROJECT-REF].indobase.in/storage/v1/s3
