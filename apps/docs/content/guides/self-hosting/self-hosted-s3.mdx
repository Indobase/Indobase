...
description: 'Enable S3-compatible client endpoint and set up an S3 backend for self-hosted Indobase Storage.'
subtitle: 'Enable S3-compatible client endpoint and set up an S3 backend for self-hosted Indobase Storage.'
---

Self-hosted Indobase Storage has two independent S3-related features:
