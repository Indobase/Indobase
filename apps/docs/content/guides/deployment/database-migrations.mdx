...
description: 'How to manage schema migrations for your Indobase project.'
subtitle: 'How to manage schema migrations for your Indobase project.'
...
You will need to [install](/docs/guides/local-development#quickstart) the Indobase CLI and start the local development stack.
...
View the [complete code](https://github.com/Indobase/Indobase/tree/master/examples/database/employees) for this example on GitHub.
...
You've been developing your project locally, making changes to your tables via migrations. It's time to deploy your project to the Indobase Platform and start scaling up to millions of users!
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Log in to the Indobase CLI">
      [Login](/docs/reference/cli/supabase-login) to the Indobase CLI using an auto-generated Personal Access Token.
    </StepHikeCompact.Details>
