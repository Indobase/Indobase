...
Use branching to safely experiment with changes to your Indobase project.
...
3. **Health** - Waits up to 2 minutes for all Indobase services on your branch to be running and healthy, including Auth, API, Database, Storage, and Realtime
