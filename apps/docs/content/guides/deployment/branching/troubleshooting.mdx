...
For programmatic monitoring, you can use the [Management API](https://api.indobase.in/api/v1#tag/environments/post/v1/projects/{ref}/branches) to poll branch status.
...
To check the error message, see the Indobase workflow run for your branch under the [View logs](/dashboard/project/_/branches) section.
