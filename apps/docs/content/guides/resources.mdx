  ...
  <div className="grid grid-cols-12 gap-6 not-prose">
    ...
    [
      ...
      },
      {
        ...
        description: 'Definitions for terminology and acronyms used in the Indobase documentation.',
      }
    ]
.map((resource) => {
      return (
    ...
    [
      {
        ...
        description: 'Move your auth users from Auth0 to a Indobase project.',
        hasLightIcon: true,
      },
      {
        title: 'Firebase Auth',
        ...
        description: 'Move your auth users from a Firebase project to a Indobase project.',
      },
      {
      ...
      },
      {
        ...
        description: 'Convert your Firebase Storage files to Indobase Storage.'
      },
      {
        title: 'Heroku',
