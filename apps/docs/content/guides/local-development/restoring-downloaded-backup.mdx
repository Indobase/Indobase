...
If you want to restore your backup to a hosted Indobase project, follow the [Migrating within Supabase guide](/docs/guides/platform/migrating-within-supabase) instead.
...
A Postgres database started with Indobase CLI is not production ready and should not be used outside of local development.
