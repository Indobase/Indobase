---
title: 'Use Indobase Auth with React'
subtitle: 'Learn how to use Indobase Auth with React.js.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    Navigate to the React app and install the Indobase libraries.
  ...
  <StepHikeCompact.Step step={5}>
    ...
    In `App.jsx`, create a Indobase client using your Project URL and key.
