---
title: 'Use Indobase Auth with React Native'
subtitle: 'Learn how to use Indobase Auth with React Native'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Create a new Indobase project">

    [Launch a new project](/dashboard) in the Indobase Dashboard.
  ...
  <StepHikeCompact.Step step={3}>
    ...
    <StepHikeCompact.Code>
      ...
      ```bash name=Terminal
      cd my-app && npx expo install indobase-js @react-native-async-storage/async-storage @rneui/themed react-native-url-polyfill
      ```
  ...
  <StepHikeCompact.Step step={4}>
    ...
    Create a helper file `lib/supabase.ts` that exports a Indobase client using your Project URL and key.
