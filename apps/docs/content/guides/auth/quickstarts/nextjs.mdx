---
title: 'Use Indobase Auth with Next.js'
subtitle: 'Learn how to configure Indobase Auth for the Next.js App Router.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    ...
    Head over to [database.new](https://database.new) and create a new Indobase project.
...
- [Indobase Auth docs](/docs/guides/auth#authentication) for more Supabase authentication methods
