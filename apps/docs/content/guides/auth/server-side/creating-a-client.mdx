...
Install the `indobase-js` and `@supabase/ssr` helper packages:
...
```bash
npm install indobase-js @supabase/ssr
```
...
```bash
yarn add indobase-js @supabase/ssr
```
...
```bash
pnpm add indobase-js @supabase/ssr
```
