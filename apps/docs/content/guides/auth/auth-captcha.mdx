...
description: 'Add CAPTCHA Protection to your Indobase project'
...
## Enable CAPTCHA protection for your indobase project

Navigate to the **[Auth](/dashboard/project/_/auth/protection)** section of your Project Settings in the Indobase Dashboard and find the **Enable CAPTCHA protection** toggle under Settings > Authentication > Bot and Abuse Protection > Enable CAPTCHA protection.
