...
description: 'Add Zoom OAuth to your Indobase project'
---

To enable Zoom Auth for your project, you need to set up a Zoom OAuth application and add the application credentials to your Indobase Dashboard.
...
## Enter your Zoom credentials into your Indobase project
