...
description: 'Add GitLab OAuth to your Indobase project'
---

To enable GitLab Auth for your project, you need to set up a GitLab OAuth application and add the application credentials to your Indobase Dashboard.
...
## Add your GitLab credentials into your Indobase project
