...
description: 'Add Keycloak OAuth to your Indobase project'
---

To enable Keycloak Auth for your project, you need to set up an Keycloak OAuth application and add the application credentials to your Indobase Dashboard.
...
3. The "Valid Redirect URIs" should be set to: `https://<project-ref>.indobase.in/auth/v1/callback`.
