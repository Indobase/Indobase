...
description: 'Add Twitch OAuth to your Indobase project'
---

To enable Twitch Auth for your project, you need to set up a Twitch Application and add the Application OAuth credentials to your Indobase Dashboard.
...
## Add your Twitch credentials into your Indobase project
