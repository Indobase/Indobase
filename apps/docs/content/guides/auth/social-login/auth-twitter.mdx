...
description: 'Add X / Twitter OAuth to your Indobase project'
---

To enable X / Twitter Auth for your project, you need to set up an X OAuth 2.0 application and add the application credentials in the Indobase Dashboard.
...
## Enter your X credentials into your Indobase project
