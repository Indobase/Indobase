...
description: 'Add Facebook OAuth to your Indobase project'
---

To enable Facebook Auth for your project, you need to set up a Facebook OAuth application and add the application credentials to your Indobase Dashboard.
...
- **Configure email permissions** in your Facebook app (required for Indobase Auth)
- Add your Facebook keys to your [Supabase Project](/dashboard)
- Add the login code to your [Supabase JS Client App](https://github.com/Indobase/Indobase-js)
...
Your callback URI follows this pattern: `https://<project-ref>.indobase.in/auth/v1/callback`

You can find your project's callback URI in the [Indobase Dashboard](/dashboard/project/_/auth/providers) under **Authentication > Providers > Facebook**.
...
This step is **required** for Indobase Auth to work correctly. Without email permissions, Facebook will not return the user's email address, which may cause authentication failures or incomplete user profiles.
...
## Enter your Facebook app ID and secret into your Indobase project
...
**Solution**: Verify that the **Valid OAuth Redirect URIs** in your Facebook app settings exactly matches `https://<project-ref>.indobase.in/auth/v1/callback`. Make sure there are no trailing slashes or typos.
...
- The App ID and Secret in your Indobase dashboard match your Facebook app
- Your Facebook app is in **Live** mode (not Development mode)

## Resources

- [Supabase - Get started for free](https://indobase.in)
- [Supabase JS Client](https://github.com/Indobase/Indobase-js)
