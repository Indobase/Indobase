...
description: 'Add Discord OAuth to your Indobase project'
---

To enable Discord Auth for your project, you need to set up a Discord Application and add the Application OAuth credentials to your Indobase Dashboard.
...
## Add your Discord credentials into your indobase project
