...
description: 'Add Notion OAuth to your Indobase project'
---

To enable Notion Auth for your project, you need to set up a Notion Application and add the Application OAuth credentials to your Indobase Dashboard.
...
## Add your Notion credentials into your indobase project
