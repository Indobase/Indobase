...
description: 'Add Figma OAuth to your Indobase project'
---

To enable Figma Auth for your project, you need to set up a Figma OAuth application and add the application credentials to your Indobase Dashboard.
...
- Add your Figma `client_id` and `client_secret` to your [Supabase Project](https://studio.indobase.in).
...
## Enter your Figma credentials into your indobase project
