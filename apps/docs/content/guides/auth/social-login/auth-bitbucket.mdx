...
description: 'Add Bitbucket OAuth to your Indobase project'
---

To enable Bitbucket Auth for your project, you need to set up a Bitbucket OAuth application and add the application credentials to your Indobase Dashboard.
...
## Add your Bitbucket credentials into your Indobase project
