...
description: 'Add GitHub OAuth to your Indobase project'
---

To enable GitHub Auth for your project, you need to set up a GitHub OAuth application and add the application credentials to your Indobase Dashboard.
...
## Enter your GitHub credentials into your Indobase project
