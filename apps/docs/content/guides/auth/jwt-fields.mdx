...
subtitle: 'Complete reference for claims appearing in JWTs created by Indobase Auth'
---
...
| -------------- | -------------------- | ----------------------------------------------------------- | --------------------------------------------- |
| `iss`          | `string`             | **Issuer** - The entity that issued the JWT                 | `"https://[PROJECT-REF].indobase.in/auth/v1"`   |
...
| ----- | -------- | --------------------------------------------------- | ------------------------ | ----------------------------- |
| `ref` | `string` | **Project Reference** - Indobase project identifier | `"abcdefghijklmnopqrst"` | Anon/Service role tokens only |
...
```json
{
  ...
  "exp": 1640995200,
  "iat": 1640991600,
  "iss": "https://abcdefghijklmnopqrst.indobase.in/auth/v1",
  "phone": "",
  "role": "authenticated",
...
4. **Verify Issuer**: Ensure `iss` matches your Indobase project
