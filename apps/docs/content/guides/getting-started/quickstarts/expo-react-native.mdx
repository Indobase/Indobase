---
title: 'Use Indobase with Expo React Native'
subtitle: 'Learn how to create a Indobase project, add some sample data to your database, and query the data from an Expo app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    The fastest way to get started is to use the `indobase-js` client library which provides a convenient interface for working with Supabase from a React Native app.
    ...
    <StepHikeCompact.Code>
      ...
      ```bash name=Terminal
      cd my-app && npx expo install indobase-js react-native-url-polyfill expo-sqlite
      ```
  ...
  <StepHikeCompact.Step step={5}>
    ...
    Create a helper file at `lib/supabase.ts` to initialize the Indobase client using the environment variables.
