---
title: 'Use Indobase with Nuxt'
subtitle: 'Learn how to create a Indobase project, add some sample data to your database, and query the data from a Nuxt app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={5}>
    ...
    In `app.vue`, create a Indobase client using your config values and replace the existing content with the following code.
