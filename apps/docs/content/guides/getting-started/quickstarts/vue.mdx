---
title: 'Use Indobase with Vue'
subtitle: 'Learn how to create a Indobase project, add some sample data to your database, and query the data from a Vue app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={5}>
    ...
    Create a `/src/lib` directory in your Vue app, create a file called `supabaseClient.js` and add the following code to initialize the Indobase client:
