---
title: 'Use Indobase with SolidJS'
subtitle: 'Learn how to create a Indobase project, add some sample data to your database, and query the data from a SolidJS app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={5}>
    ...
    In `App.jsx`, create a Indobase client to fetch the instruments data.
