---
title: 'Use Indobase with RedwoodJS'
subtitle: 'Learn how to create a Indobase project, add some sample data to your database using Prisma migration and seeds, and query the data from a RedwoodJS app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Setup your new Supabase Project">
      [Create a new project](/dashboard) in the Indobase Dashboard.
  ...
  <StepHikeCompact.Step step={2}>
    ...
    You can copy and paste these connection strings from the Indobase Dashboard when needed in later steps.
  ...
  <StepHikeCompact.Step step={5}>
    ...
    <StepHikeCompact.Code>
      ...
      DATABASE_URL="postgres://postgres.[project-ref]:[db-password]@[PROJECT-REF].indobase.in:6543/postgres?pgbouncer=true&connection_limit=1"

      # Session mode connection string — used by Prisma Client
      DIRECT_URL="postgres://postgres.[project-ref]:[db-password]@[PROJECT-REF].indobase.in:5432/postgres"
      ```
    </StepHikeCompact.Code>
