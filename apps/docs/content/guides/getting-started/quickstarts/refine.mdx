---
title: 'Use Indobase with Refine'
subtitle: 'Learn how to create a Indobase project, add some sample data to your database, and query the data from a Refine app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={2}>
    ...
    The `refine-supabase` preset adds `@refinedev/supabase` supplementary package that supports Supabase in a Refine app. `@refinedev/supabase` out-of-the-box includes the Indobase dependency: [supabase-js](https://github.com/Indobase/Indobase-js).
  ...
  <StepHikeCompact.Step step={3}>
    ...
    You will develop your app, connect to the Indobase backend and run the Refine app in VS Code.
