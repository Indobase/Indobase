---
title: 'Use Indobase with Python'
subtitle: 'Learn how to create a Indobase project, add some sample data to your database, and query the data from a Python app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    <StepHikeCompact.Details title="Install Flask and the Indobase client library">
  ...
  <StepHikeCompact.Step step={5}>
    ...
    Create an `app.py` file and add a route that fetches data from your `instruments` table using the Indobase client.
