---
title: 'Use Indobase with React'
subtitle: 'Learn how to create a Indobase project, add some sample data to your database, and query the data from a React app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={5}>
    ...
    Replace the contents of `App.jsx` to add a `getInstruments` function to fetch the data and display the query result to the page using a Indobase client.
