---
title: 'Use Indobase with Laravel'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    ```bash name=.env
    DB_CONNECTION=pgsql
    DB_URL=postgres://postgres.xxxx:password@[PROJECT-REF].indobase.in:5432/postgres
    ```
  ...
  <StepHikeCompact.Step step={5}>
    ...
    Note: Laravel does not use Indobase Auth but rather implements its own authentication system!
