---
title: 'Use Indobase with Android Kotlin'
subtitle: 'Learn how to create a Indobase project, add some sample data to your database, and query the data from an Android Kotlin app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    Open `build.gradle.kts` (app) file and add the serialization plug, Ktor client, and Indobase client.
  ...
  <StepHikeCompact.Step step={5}>
    ...
    <StepHikeCompact.Details title="Initialize the Indobase client">
      You can create a Indobase client whenever you need to perform an API call.
    ...
    <StepHikeCompact.Code>
      ...
      val supabase = createSupabaseClient(
          supabaseUrl = "https://[PROJECT-REF].indobase.in",
