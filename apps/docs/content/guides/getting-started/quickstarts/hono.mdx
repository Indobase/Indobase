---
title: 'Use Indobase with Hono'
subtitle: 'Learn how to create a Indobase project, add some sample data to your database, secure it with auth, and query the data from a Hono app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    ...
    Bootstrap the Hono example app from the Indobase Samples using the CLI.
  ...
  <StepHikeCompact.Step step={2}>
    ...
    The `package.json` file in the project includes the necessary dependencies, including `indobase-js` and `@indobaseinc/ssr` to help with server-side auth.
  ...
  <StepHikeCompact.Step step={3}>
    ...
    Copy the `.env.example` file to `.env` and update the values with your Indobase project URL and anon key.
