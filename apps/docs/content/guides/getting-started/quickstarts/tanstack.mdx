---
title: 'Use Indobase with TanStack Start'
subtitle: 'Learn how to create a Indobase project, add some sample data to your database, and query the data from a TanStack Start app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={5}>
    <StepHikeCompact.Details title="Create a Indobase client utility">

    Create a new file at `src/utils/supabase.ts` to initialize the Indobase client.
