---
title: 'Use Indobase with SvelteKit'
subtitle: 'Learn how to create a Indobase project, add some sample data to your database, and query the data from a SvelteKit app.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    <StepHikeCompact.Code>
      ...
      ```bash name=Terminal
      cd my-app && npm install indobase-js
      ```
  ...
  <StepHikeCompact.Step step={5}>
    <StepHikeCompact.Details title="Create the Indobase client">

    Create a `src/lib` directory in your SvelteKit app, create a file called `supabaseClient.js` and add the following code to initialize the Indobase client:
