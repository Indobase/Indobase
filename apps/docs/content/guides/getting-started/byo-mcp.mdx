...
description: 'Build and deploy remote MCP servers on Indobase Edge Functions'
---
...
- [Deno](https://deno.land/) installed (Indobase Edge Functions runtime)
- [Indobase CLI](/docs/guides/local-development) installed and authenticated
- [Node.js 20 or later](https://nodejs.org/) (required by Indobase CLI)

## Deploy your MCP server

### Step 1: Create a new project

Start by creating a new Indobase project:
...
Start the Indobase local development stack:
...
```
https://[PROJECT-REF].indobase.in/functions/v1/mcp
```
...
- [Simple MCP server](https://github.com/Indobase/Indobase/tree/master/examples/edge-functions/supabase/functions/mcp/simple-mcp-server) - Basic unauthenticated example
