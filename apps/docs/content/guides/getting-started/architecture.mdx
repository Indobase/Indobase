...
Each Indobase project consists of several tools:
...
- Official Docs: [Indobase docs](/docs)
- Source code: [github.com/Indobase/Indobase](https://github.com/Indobase/Indobase/tree/master/apps/studio)
- License: [Apache 2](https://github.com/Indobase/Indobase/blob/master/LICENSE)
- Language: TypeScript
...
- Official Docs: [Indobase Auth reference docs](/docs/reference/auth)
...
- Official Docs: [Indobase Realtime docs](/docs/guides/realtime)
...
- Official Docs: [Indobase Storage reference docs](/docs/reference/storage)
