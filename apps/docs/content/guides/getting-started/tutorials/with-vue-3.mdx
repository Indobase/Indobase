...
If you get stuck while working through this guide, refer to the [full example on GitHub](https://github.com/Indobase/Indobase/tree/master/examples/user-management/vue3-user-management).
...
Then let's install the only additional dependency: [supabase-js](https://github.com/Indobase/Indobase-js)
...
With the API credentials in place, create an `src/supabase.js` helper file to initialize the Indobase client. These variables are exposed
