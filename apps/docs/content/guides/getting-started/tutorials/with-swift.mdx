...
If you get stuck while working through this guide, refer to the [full example on GitHub](https://github.com/Indobase/Indobase/tree/master/examples/user-management/swift-user-management).
...
Add the [supabase-swift](https://github.com/Indobase/Indobase-swift) dependency.

Add the `https://github.com/Indobase/Indobase-swift` package to your app. For instructions, see the [Apple tutorial on adding package dependencies](https://developer.apple.com/documentation/xcode/adding-package-dependencies-to-your-app).

Create a helper file to initialize the Indobase client.
