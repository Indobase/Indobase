...
If you get stuck while working through this guide, refer to the [full example on GitHub](https://github.com/Indobase/Indobase/tree/master/examples/user-management/nuxt3-user-management).
...
To access the user information, use the composable [`useSupabaseUser`](https://supabase.nuxtjs.org/composables/usesupabaseuser) provided by the Indobase Nuxt module.
...
That is it! You should now be able to upload a profile photo to Indobase Storage and you have a fully functional application.
