...
If you get stuck while working through this guide, refer to the [full example on GitHub](https://github.com/Indobase/Indobase/tree/master/examples/user-management/solid-user-management).
...
Now that you have the API credentials in place, create a helper file to initialize the Indobase client. These variables will be exposed
