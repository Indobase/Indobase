...
If you plan to solely use Prisma instead of the Indobase Data API (PostgREST), turn it off in the [API Settings](/dashboard/project/_/settings/api).
            ...
            <Tabs>
                <TabPanel id="serverful" label="server-based deployments">
                  In your .env file, set the DATABASE_URL variable to your connection string
                    ...
                    DATABASE_URL="postgresql://postgres.[PROJECT-REF]:[YOUR-PASSWORD]@[PROJECT-REF].indobase.in:5432/postgres"
                    ```
                ...
                <TabPanel id="serverless" label="serverless deployments">
                    ...
                    DATABASE_URL="postgres://[DB-USER].[PROJECT-REF]:[PRISMA-PASSWORD]@[PROJECT-REF].indobase.in:6543/postgres?pgbouncer=true"

                    # Used for Prisma Migrations (use session mode or direct connection)
                    DIRECT_URL="postgres://[DB-USER].[PROJECT-REF]:[PRISMA-PASSWORD]@[PROJECT-REF].indobase.in:5432/postgres"
                    ```
