...
You can run this query using the [SQL Editor](/dashboard/project/_/sql) in the Indobase Dashboard, or via `psql` if you're [connecting directly to the database](/docs/guides/database/connecting-to-postgres#direct-connections).
