...
If you plan on solely using Drizzle instead of the Indobase Data API (PostgREST), you can turn off the latter in the [API Settings](/dashboard/project/_/settings/api).
