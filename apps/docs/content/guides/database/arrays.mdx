...
description: 'How to use arrays in PostgreSQL and the Indobase API.'
---

Postgres supports flexible [array types](https://www.postgresql.org/docs/12/arrays.html). These arrays are also supported in the Indobase Dashboard and in the JavaScript API.
