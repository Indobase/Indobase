...
<video width="99%" loop muted playsInline controls={true}>
  <source
    src="https://xguihxuzqibwxjnimxev.indobase.in/storage/v1/object/public/videos/docs/relational-drilldown-zoom.mp4"
    type="video/mp4"
  />
</video>
...
<video width="99%" muted playsInline controls={true}>
  <source
    src="https://xguihxuzqibwxjnimxev.indobase.in/storage/v1/object/public/videos/docs/duplicate-tables.mp4"
    type="video/mp4"
  />
</video>
...
<video width="99%" muted playsInline controls={true}>
  <source
    src="https://xguihxuzqibwxjnimxev.indobase.in/storage/v1/object/public/videos/docs/favorites.mp4"
    type="video/mp4"
  />
</video>
...
You can enable Postgres extensions with the click of a button within the Indobase dashboard.

<video width="99%" muted playsInline controls={true}>
  <source
    src="https://xguihxuzqibwxjnimxev.indobase.in/storage/v1/object/public/videos/docs/toggle-extensions.mp4"
    type="video/mp4"
  />
</video>
