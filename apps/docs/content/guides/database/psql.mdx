...
Download your [SSL certificate](#connecting-with-ssl) to `/path/to/indobase-ca.cer`.
...
```shell
psql "sslmode=verify-full sslrootcert=/path/to/indobase-ca.cer host=[PROJECT-REF].indobase.in dbname=postgres user=postgres.[PROJECT_REF]"
```
