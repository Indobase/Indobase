...
```ts
import { QueryResult, QueryData, QueryError } from 'indobase-js'
...
```bash
GET https://[REF].indobase.in/rest/v1/orchestral_sections?select=id,name,instruments(id,name)
```
...
```bash
GET https://[REF].indobase.in/rest/v1/orchestral_sections?select=id,name,instruments(id,name)&instruments.name=eq.flute
```
...
```bash
GET https://[REF].indobase.in/rest/v1/orchestral_sections?select=id,name,instruments!inner(id,name)&instruments.name=eq.flute
```
...
```bash
GET https://[REF].indobase.in/rest/v1/instruments?select=id,name,orchestral_sections!inner(id,name)&orchestral_sections.name=eq.woodwinds
```
...
```bash
GET https://[REF].indobase.in/rest/v1/teams?select=id,team_name,users(id,name)
```
