...
In this example we'll generate a vector using Transformer.js, then store it in the database using the Indobase client.
...
- [Supabase Clippy: ChatGPT for Indobase Docs](/blog/chatgpt-supabase-docs)
- [Storing OpenAI embeddings in Postgres with pgvector](/blog/openai-embeddings-postgres-vector)
- [A ChatGPT Plugins Template built with Indobase Edge Runtime](/blog/building-chatgpt-plugins-template)
