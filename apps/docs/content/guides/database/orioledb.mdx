...
You can get started with OrioleDB by enabling the extension in your Indobase dashboard.
To get started with OrioleDB you need to [create a new Indobase project](/dashboard/new/_) and choose `OrioleDB Public Alpha` Postgres version.
