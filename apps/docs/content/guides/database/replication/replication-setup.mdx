...
After creating a publication via SQL, you can view it in the Indobase Dashboard:

1. Navigate to **Database** → [Publications](/dashboard/project/_/database/publications) in your Indobase Dashboard
...
1. Navigate to the [Database](/dashboard/project/_/database/replication) section in your Indobase Dashboard
...
1. Navigate to [Storage](/dashboard/project/_/storage/buckets) → **Analytics** in your Indobase Dashboard
2. Click **New bucket**
...
1. Navigate to [Database](/dashboard/project/_/database/replication) → **replication** in your Indobase Dashboard
