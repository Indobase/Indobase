...
> = {
  table: {
    ...
    docsUrl:
      'https://indobase.in/docs/guides/database/database-linter?lint=0013_rls_disabled_in_public',
  },
  'foreign table': {
    ...
    docsUrl:
      'https://indobase.in/docs/guides/database/database-linter?lint=0017_foreign_table_in_api',
  },
  'materialized view': {
    ...
    docsUrl:
      'https://indobase.in/docs/guides/database/database-linter?lint=0016_materialized_view_in_api',
  },
  view: {
    ...
    docsUrl:
      'https://indobase.in/docs/guides/database/database-linter?lint=0010_security_definer_view',
  },
}
