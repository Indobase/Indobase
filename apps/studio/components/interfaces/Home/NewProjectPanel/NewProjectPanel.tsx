          ...
          {authEnabled && edgeFunctionsEnabled && storageEnabled && (
            <div className="flex h-full flex-col justify-between space-y-6">
              <div className="max-w-2xl space-y-2">
                ...
                <p className="text-base text-foreground-light">
                  Indobase provides all the backend features you need to build a product. You can
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-base text-foreground-light text-balance">
              ...
              <InlineLink href={`${DOCS_URL}/reference`}>Indobase client libraries</InlineLink> and
              your API keys.
            </p>
          </div>
          <div className="flex items-center space-x-2">
