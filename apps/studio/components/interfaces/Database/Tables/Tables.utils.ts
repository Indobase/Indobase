import { PostgresMaterializedView, PostgresTable, PostgresView } from '@indobaseinc/postgres-meta'
import { PostgresForeignTable } from '@indobaseinc/postgres-meta/dist/lib/types'
