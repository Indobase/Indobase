...
You will be able to connect a GitHub repository to an Indobase project.
...
`
  ...
  const GitHubContentSectionBottom = gitHubAuthorization
    ? `You are authorized with the Indobase GitHub App. You can configure your GitHub App installations and repository access [here](${GITHUB_INTEGRATION_INSTALLATION_URL}). You can revoke your authorization [here](${GITHUB_INTEGRATION_REVOKE_AUTHORIZATION_URL}).`
    : ''
