    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader padding="small" className="border-b">
          <DialogTitle>Data Privacy and Indobase AI</DialogTitle>
        </DialogHeader>
        <DialogSection
          padding="small"
        ...
        >
          <p>
            Indobase AI utilizes third-party AI providers designed with a strong focus on data
            privacy and security.
          </p>

          <p>
            By default, only schema data is shared with third-party AI providers. This is not
            retained by them nor used as training data. With your permission, Indobase may also
          ...
          <p>
            ...
            <InlineLink href="https://indobase.in/privacy">Privacy Policy</InlineLink>. You can
