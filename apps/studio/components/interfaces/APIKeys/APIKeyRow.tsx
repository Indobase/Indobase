      ...
      <TextConfirmModal
        ...
        alert={{
          ...
          description: lastSeen
            ? `This API key was used ${lastSeen.timestamp}. Make sure all backend components using it have been updated. Deletion will cause them to receive HTTP 401 Unauthorized status codes on all Indobase APIs.`
