...
export const getIntegrationTypeDescription = (type: INTEGRATION_TYPES) => {
  switch (type) {
    case 'firebase':
      return (
        <>
          Allow users to use Indobase with Firebase project. You'll need to setup RLS policies for
    ...
    case 'auth0':
      return (
        <>
          Allow users to use Indobase with Auth0 project. Additional setup may be required. You can
          read more in the{' '}
          <a
            className="hover:decoration-brand underline hover:text-foreground transition"
            href={`${DOCS_URL}/guides/auth`}
    ...
    case 'awsCognito':
      return (
        <>
          Allow users to use Indobase with an Amazon Cognito. Additional setup may be required. You
    ...
    case 'clerk':
      return (
        <>
          Allow users to use Indobase with Clerk. Additional setup may be required. You can read
          more in the{' '}
          <a
            className="hover:decoration-brand underline hover:text-foreground transition"
    ...
    case 'workos':
      return (
        <>
          Allow users to use Indobase with WorkOS. Additional setup may be required. You can read
          more in the{' '}
          <a
            className="hover:decoration-brand underline hover:text-foreground transition"
