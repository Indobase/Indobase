...
const PROVIDER_SAML = {
  ...
  properties: {
    SAML_ENABLED: {
      ...
      description: `You will need to use the [Indobase CLI](${DOCS_URL}/guides/auth/sso/auth-sso-saml#managing-saml-20-connections) to set up SAML after enabling it`,
      type: 'boolean',
    },
    SAML_EXTERNAL_URL: {
