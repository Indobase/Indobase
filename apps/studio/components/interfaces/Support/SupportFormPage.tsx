  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-y-2">
      <div className="flex items-center space-x-3">
        ...
        <h3 className="m-0 text-lg">Indobase support</h3>
      </div>
      ...
      <div className="flex items-center gap-x-3">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
              <Link href="https://status.indobase.in/" target="_blank" rel="noreferrer">
                {isLoading
                  ? 'Checking status'
                  : isError
          ...
          <TooltipContent side="bottom" align="center">
            Check the Indobase status page
          </TooltipContent>
        </Tooltip>
      </div>
    </div>
        ...
        <>
          ...
          <p className="flex items-center gap-x-1.5 flex-wrap">
            ...
            <span className="inline-flex items-center gap-x-1">
              <a
                href={`mailto:support@indobase.in?subject=${encodeURIComponent('Support Request')}${hasProjectRef ? `${encodeURIComponent(' for Project ID: ')}${encodeURIComponent(projectRef)}` : ''}&body=${encodeURIComponent('Here is a detailed description of the problem I am experiencing and any other information that might be helpful...')}`}
