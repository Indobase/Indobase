...
describe('useChartHoverState', () => {
  ...
  describe('initialization', () => {
    ...
    it('should load sync settings from localStorage on initialization', async () => {
      localStorageMock.setItem('indobase-chart-hover-sync-enabled', 'true')
      localStorageMock.setItem('indobase-chart-tooltip-sync-enabled', 'true')
    ...
    it('should handle corrupted localStorage data gracefully', async () => {
      localStorageMock.setItem('indobase-chart-hover-sync-enabled', 'invalid-json')
      localStorageMock.setItem('indobase-chart-tooltip-sync-enabled', 'invalid-json')
  ...
  describe('sync settings', () => {
    it('should enable hover sync and save to localStorage', () => {
      ...
      expect(localStorageMock.setItem).toHaveBeenCalledWith(
        'indobase-chart-hover-sync-enabled',
        'true'
      )
    })
    ...
    it('should enable tooltip sync and automatically enable hover sync', () => {
      ...
      expect(localStorageMock.setItem).toHaveBeenCalledWith(
        'indobase-chart-tooltip-sync-enabled',
        'true'
      )
    })
