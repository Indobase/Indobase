      ...
      <PopoverContent_Shadcn_ align="end" className="w-80 px-0">
        {hasLatestCLIVersion ? (
          !isBeta && hasUpdate ? (
            <div className="px-4 mb-3">
              <p className="text-sm mb-2">A new version of Indobase CLI is available:</p>
            ...
            <div className="px-4 mb-3">
              {isBeta ? (
                <p className="text-sm">You're on the Beta version of Indobase CLI</p>
              ) : (
                <p className="text-sm">You're on the latest version of Indobase CLI</p>
              )}
            </div>
          )
        ) : null}
        ...
        <div className="flex flex-col gap-y-2 px-4">
          <p className="text-xs text-foreground-lighter">
            ...
            <InlineLink href="https://github.com/Indobase/cli/releases">
              GitHub repository
            </InlineLink>
            .
          </p>
            ...
            <DialogContent>
              ...
              <DialogSection className="flex flex-col gap-y-3">
                <div className="flex flex-col gap-y-2">
                  ...
                  <p className="text-sm">
                    Indobase CLI releases follows a two-week schedule, with stable updates available
                    through the{' '}
                    <InlineLink
                      href={`${DOCS_URL}/guides/local-development/cli/getting-started?queryGroups=platform&platform=linux#updating-the-indobase-cli`}
                    >
                      CLI
                    </InlineLink>
                    .
