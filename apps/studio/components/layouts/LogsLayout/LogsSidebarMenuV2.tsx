...
import { IndobaseStackIcon } from 'components/icons/IndobaseStackIcon'
    ...
    <div className="pb-4 relative">
      {IS_SAAS && !unifiedLogsFlagEnabled && (
        <FeaturePreviewSidebarPanel
          ...
          actions={
            <Link href="https://forms.indobase.in/unified-logs-signup" target="_blank">
            ...
            {filteredLogs.map((collection) => {
              ...
              return (
                <LogsSidebarItem
                  ...
                  href={collection?.url ?? ''}
                  icon={<IndobaseStackIcon size={15} />}
