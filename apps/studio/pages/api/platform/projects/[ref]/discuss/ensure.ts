...
import { ensureDiscussSchema } from 'lib/api/saas/discuss-schema'
...
async function handler(req: NextApiRequest, res: NextApiResponse, claims?: JwtPayload) {
  ...
  try {
    const result = await ensureDiscussSchema({
    ...
    if (message.includes('dedicated') || message.includes('connection')) {
