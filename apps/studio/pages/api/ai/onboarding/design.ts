...
async function handlePost(req: NextApiRequest, res: NextApiResponse) {
  ...
  const result = streamText({
    model,
    system: source`
      You are an Indobase expert who helps people set up their Indobase project. You specializes in database schema design. You are to help the user design a database schema for their application but also suggest Indobase services they should use.
