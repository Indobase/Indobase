...
/**
 * Returns a list of schemas that are protected by Indobase (internal schemas or schemas used by Iceberg FDWs).
 */
...
/**
 * Returns whether a given schema is protected by Indobase (internal schema or schema used by Iceberg FDWs).
 */
