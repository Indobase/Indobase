...
describe('api/saas/settings', () => {
  let mockAssertSaaSBackend: ReturnType<typeof vi.fn>
  ...
  beforeEach(async () => {
    ...
    mockAssertSaaSBackend = vi.mocked(util.assertSaaSBackend)
  })
  ...
  describe('getProjectSettings', () => {
    it('should call assertSaaSBackend', () => {
      ...
      expect(mockAssertSaaSBackend).toHaveBeenCalled()
    })
    ...
    it('should return correct default values', async () => {
      ...
      expect(settings.ref).toBe('abcdefghijklmnopqrst')
