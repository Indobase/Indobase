...
const WHITELIST_ERRORS = [
  ...
  'Project creation in the Indobase dashboard is disabled for this Vercel-managed organization.',
  'Your account, which is handled by the Fly Indobase extension, cannot access this endpoint.',
