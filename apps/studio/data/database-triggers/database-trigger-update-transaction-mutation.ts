...
import { PGTrigger, PGTriggerCreate } from '@indobaseinc/pg-meta/src/pg-meta-triggers'
...
// Copying the SQL from https://github.com/Indobase/postgres-meta/blob/master/src/lib/PostgresMetaTriggers.ts
