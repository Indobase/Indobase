    ...
    <div class="container overflow-x-hidden max-md:px-5!">
        <div class="mx-auto mb-20 flex max-w-2xl flex-col items-center gap-4 text-center">
            <h2 class="text-display text-primary font-aeonik-pro">
                ...
                <div
                    class="relative inline-flex bg-[linear-gradient(-146deg,_#3b8fd6,_#19191D_47%,_#19191D)] bg-clip-text pb-2 text-transparent"
                >
                    {activePlatformText}
                    <div
                        class="animate-caret-blink -right-2 bottom-0 mt-1 ml-2 block h-full min-h-14 w-px bg-[linear-gradient(-146deg,_#3b8fd6,_#19191D_47%,_#19191D)]"
                    ></div>
                </div>
            </h2>
