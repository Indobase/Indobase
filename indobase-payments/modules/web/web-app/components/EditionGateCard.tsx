...
/**
 * Upgrade prompt shown where a Indobase Payments Cloud / Enterprise feature would be in the
...
export const EditionGateCard: FunctionComponent<EditionGateCardProps> = ({
  ...
  description,
  layout = 'centered',
  compareHref = 'https://indobase.in/pricing',
  learnMoreHref = 'https://docs.indobase.in',
}) => {
  const card = (
