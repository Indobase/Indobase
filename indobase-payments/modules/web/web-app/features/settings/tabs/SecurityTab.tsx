 ...
 * log — is a Indobase Payments Cloud / Enterprise feature.
 *
...
export const SecurityTab: FunctionComponent = () => {
  return (
    <EditionGateCard
      ...
      description="Enforcing two-factor authentication across your organization and reviewing the security activity log are part of Indobase Payments Cloud and Enterprise edition."
    />
  )
}
