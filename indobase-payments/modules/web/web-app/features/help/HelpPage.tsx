...
const copyEmail = () => {
  copyToClipboard('payments@indobase.in')
...
const sendFeedback = async (
  ...
  try {
    ...
    if (res.status === 200) {
      ...
      toast.error('Failed to send feedback, please send us an email at payments@indobase.in')
    }
  } catch (e) {
    toast.error('Failed to send feedback, please send us an email at payments@indobase.in')
  }
    ...
    <div className="space-y-6 w-full border-t pt-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Get help, share feedback, or connect with the Indobase community
        </p>
      </div>
        ...
        <div className="space-y-4">
          <div className="border border-border rounded-lg p-6">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              <span>Indobase Payments is built with the community.</span>
              <br />
            ...
            <div className="text-xs pt-2">
              ...
              <a
                className="underline"
                href="mailto:payments@indobase.in"
                target="_blank"
