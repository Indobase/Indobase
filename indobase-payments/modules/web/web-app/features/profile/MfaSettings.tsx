...
/**
 * Two-factor authentication (TOTP) for user accounts is a Indobase Payments Cloud /
 * Enterprise feature.
 *
...
export const MfaSettings: FunctionComponent = () => {
  return (
    <EditionGateCard
      ...
      description="Protecting your account with an authenticator app (TOTP) is part of Indobase Payments Cloud and Enterprise edition."
    />
  )
}
