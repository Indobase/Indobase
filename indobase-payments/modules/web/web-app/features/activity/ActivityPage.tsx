...
/**
 * The organization-wide audit log is a Indobase Payments Cloud / Enterprise feature.
 *
...
export const ActivityPage: FunctionComponent = () => {
  return (
    <EditionGateCard
      ...
      description="The organization-wide audit log — a searchable trail of every system and user action across your tenant — is part of Indobase Payments Cloud and Enterprise edition."
    />
  )
}
