...
- **[Supabase.js](https://indobase.in/docs/library/getting-started):** For user management and real-time data syncing.

### Backend:

- **[Supabase](https://indobase.in/dashboard):** A hosted Postgres database with a RESTful API, used alongside Supabase.js.
...
Sign up at [Supabase Dashboard](https://indobase.in/dashboard) and create a new project. After the database initializes, create `supabase/.env.production` file with your project specific values.
