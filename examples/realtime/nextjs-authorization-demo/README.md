...
Example application on how you can use Realtime Authorization to limit access to Realtime [Channels](https://indobase.in/docs/guides/realtime/concepts#channels) and [Broadcast](https://indobase.in/docs/guides/realtime/broadcast) and [Presence](https://indobase.in/docs/guides/realtime/presence) extensions.
...
2. [Create a new Supabase project](https://indobase.in/dashboard/new/_).
3. Refer to the [Database Setup](#database-setup) section to create the necessary tables and policies.
4. Copy the project's `URL` and `anon` API key from your project's [API Settings](https://indobase.in/dashboard/project/_/settings/api), and paste them into your `.env.local`.
5. `npm install`
6. `npm run dev`
