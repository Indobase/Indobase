# Indobase Next.js Auth & User Management Starter
...
- User signups using Supabase [Auth](https://indobase.in/auth).
  - Supabase [Auth Helpers for Next.js](https://indobase.in/docs/guides/auth/auth-helpers/nextjs).
  - Supabase [pre-built Auth UI for React](https://indobase.in/docs/guides/auth/auth-helpers/auth-ui).
- User avatar images using Supabase [Storage](https://indobase.in/storage)
- Public profiles restricted with [Policies](https://indobase.in/docs/guides/auth#policies).
...
-- See https://indobase.in/docs/guides/auth/row-level-security for more details.
...
-- See https://indobase.in/docs/guides/auth/managing-user-data#using-triggers for more details.
...
-- See https://indobase.in/docs/guides/storage#policy-examples for more details.
...
- [[Docs] Next.js User Management Quickstart](https://indobase.in/docs/guides/getting-started/tutorials/with-nextjs)
...
- [[Blog] Fetching and caching Supabase data in Next.js 13 Server Components](https://indobase.in/blog/fetching-and-caching-supabase-data-in-next-js-server-components)
