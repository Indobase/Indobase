      ...
      <Layout style={{ minHeight: '100vh', backgroundColor: '#F9F9F9' }}>
        <Layout>
          ...
          >
            ...
            >
              <img
                src={collapsed ? '/console/indobase-logo.svg' : '/console/indobase-logo-wordmark.svg'}
                alt="Indobase Email"
                style={{
                  height: '31px',
                  width: 'auto',
                  ...
                  items: [
                    {
                      ...
                      label: (
                        <a
                          href="https://github.com/Indobase/Indobase/tree/main/indobase-email"
                          target="_blank"
                    ...
                    },
                    {
                      ...
                      label: (
                        <a
                          href="https://github.com/Indobase/Indobase/issues"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
