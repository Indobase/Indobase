...
type CommonStrings struct {
	...
	TeamName string // signature team name, e.g. "The Indobase Team"
}
...
var englishTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hello,",
		TeamName: "The Indobase Team",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Your Indobase Email authentication code",
		Heading:      "Your authentication code",
		Intro:        "Your authentication code for Indobase Email is:",
		Expiry:       "The code will expire in 10 minutes.",
		IgnoreNotice: "If you did not request this code, please ignore this email.",
		SignOff:      "Thanks,",
	},
	Invitation: InvitationStrings{
		Subject:     "You've been invited to join %s on Indobase Email",
		Heading:     "You've been invited to join Indobase Email!",
		Body:        "%[1]s has invited you to join the %[2]s workspace on Indobase Email.",
...
var frenchTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Bonjour,",
		TeamName: "L'équipe Indobase",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Votre code d'authentification Indobase Email",
		Heading:      "Votre code d'authentification",
		Intro:        "Votre code d'authentification pour Indobase Email est :",
		Expiry:       "Ce code expirera dans 10 minutes.",
		IgnoreNotice: "Si vous n'avez pas demandé ce code, veuillez ignorer cet e-mail.",
		SignOff:      "Merci,",
	},
	Invitation: InvitationStrings{
		Subject:     "Vous avez été invité à rejoindre %s sur Indobase Email",
		Heading:     "Vous avez été invité à rejoindre Indobase Email !",
		Body:        "%[1]s vous a invité à rejoindre l'espace de travail %[2]s sur Indobase Email.",
...
var spanishTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hola,",
		TeamName: "El equipo de Indobase",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Tu código de autenticación de Indobase Email",
		Heading:      "Tu código de autenticación",
		Intro:        "Tu código de autenticación para Indobase Email es:",
		Expiry:       "El código caducará en 10 minutos.",
		IgnoreNotice: "Si no solicitaste este código, ignora este correo electrónico.",
		SignOff:      "Gracias,",
	},
	Invitation: InvitationStrings{
		Subject:     "Te han invitado a unirte a %s en Indobase Email",
		Heading:     "¡Te han invitado a unirte a Indobase Email!",
		Body:        "%[1]s te ha invitado a unirte al espacio de trabajo %[2]s en Indobase Email.",
...
var germanTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hallo,",
		TeamName: "Das Indobase-Team",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Ihr Indobase-Email-Authentifizierungscode",
		Heading:      "Ihr Authentifizierungscode",
		Intro:        "Ihr Authentifizierungscode für Indobase Email lautet:",
	...
	Invitation: InvitationStrings{
		Subject:     "Sie wurden eingeladen, %s auf Indobase Email beizutreten",
		Heading:     "Sie wurden zu Indobase Email eingeladen!",
		Body:        "%[1]s hat Sie eingeladen, dem Workspace %[2]s auf Indobase Email beizutreten.",
...
var catalanTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hola,",
		TeamName: "L'equip d'Indobase",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "El teu codi d'autenticació d'Indobase Email",
		Heading:      "El teu codi d'autenticació",
		Intro:        "El teu codi d'autenticació per a Indobase Email és:",
		Expiry:       "El codi caducarà en 10 minuts.",
		IgnoreNotice: "Si no has sol·licitat aquest codi, ignora aquest correu electrònic.",
		SignOff:      "Gràcies,",
	},
	Invitation: InvitationStrings{
		Subject:     "T'han convidat a unir-te a %s a Indobase Email",
		Heading:     "T'han convidat a unir-te a Indobase Email!",
		Body:        "%[1]s t'ha convidat a unir-te a l'espai de treball %[2]s a Indobase Email.",
...
var portugueseBRTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Olá,",
		TeamName: "A equipe da Indobase",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Seu código de autenticação da Indobase Email",
		Heading:      "Seu código de autenticação",
		Intro:        "Seu código de autenticação para a Indobase Email é:",
		Expiry:       "O código expirará em 10 minutos.",
		IgnoreNotice: "Se você não solicitou este código, ignore este e-mail.",
		SignOff:      "Obrigado,",
	},
	Invitation: InvitationStrings{
		Subject:     "Você foi convidado para participar de %s na Indobase Email",
		Heading:     "Você foi convidado para participar da Indobase Email!",
		Body:        "%[1]s convidou você para participar do espaço de trabalho %[2]s na Indobase Email.",
...
var japaneseTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "こんにちは、",
		TeamName: "Indobase チーム",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Indobase Email 認証コード",
		Heading:      "認証コード",
		Intro:        "Indobase Email の認証コードは次のとおりです:",
		Expiry:       "このコードは10分後に有効期限が切れます。",
		IgnoreNotice: "このコードをリクエストしていない場合は、このメールを無視してください。",
		SignOff:      "よろしくお願いいたします、",
	},
	Invitation: InvitationStrings{
		Subject:     "%s に参加するよう招待されました（Indobase Email）",
		Heading:     "Indobase Email への参加に招待されました！",
		Body:        "%[1]s さんが、Indobase Email のワークスペース %[2]s への参加にあなたを招待しました。",
...
var italianTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Ciao,",
		TeamName: "Il team di Indobase",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Il tuo codice di autenticazione Indobase Email",
		Heading:      "Il tuo codice di autenticazione",
		Intro:        "Il tuo codice di autenticazione per Indobase Email è:",
		Expiry:       "Il codice scadrà tra 10 minuti.",
		IgnoreNotice: "Se non hai richiesto questo codice, ignora questa email.",
		SignOff:      "Grazie,",
	},
	Invitation: InvitationStrings{
		Subject:     "Sei stato invitato a unirti a %s su Indobase Email",
		Heading:     "Sei stato invitato a unirti a Indobase Email!",
		Body:        "%[1]s ti ha invitato a unirti allo spazio di lavoro %[2]s su Indobase Email.",
