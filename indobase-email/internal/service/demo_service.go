...
func (s *DemoService) createDemoWorkspace(ctx context.Context) error {
	...
	workspace, err := s.workspaceService.CreateWorkspace(
		...
		"https://indobase.in/favicon.ico",
		"https://email.indobase.in/cover.png",
		"UTC",
		fileManagerSettings,
...
func (s *DemoService) createDemoSMTPIntegration(ctx context.Context, workspaceID string) error {
	...
	smtpProvider := domain.EmailProvider{
		...
		Senders: []domain.EmailSender{
			{
				ID:        uuid.New().String(),
				Email:     "demo@indobase.in",
				Name:      "Indobase Email Demo",
				IsDefault: true,
			},
		},
...
func (s *DemoService) createSampleTemplates(ctx context.Context, workspaceID string) error {
	...
	passwordResetTestData := domain.MapOfAny{
		...
		"reset_url": "https://email.indobase.in/reset-password?token=demo_token_123",
	}
...
func getNewsletterContents() map[string]newsletterContent {
	return map[string]newsletterContent{
		"en": {
			...
			footerText: "You received this email because you're subscribed to our newsletter.<br><a href=\"{{unsubscribe_url}}\">Unsubscribe</a> | <a href=\"https://email.indobase.in\">Visit our website</a>",
		},
		"fr": {
			lang:       "fr",
			...
			footerText: "Vous recevez cet e-mail car vous êtes abonné(e) à notre newsletter.<br><a href=\"{{unsubscribe_url}}\">Se désabonner</a> | <a href=\"https://email.indobase.in\">Visiter notre site</a>",
		},
		"es": {
			lang:       "es",
			...
			footerText: "Recibes este correo porque estás suscrito/a a nuestro boletín.<br><a href=\"{{unsubscribe_url}}\">Cancelar suscripción</a> | <a href=\"https://email.indobase.in\">Visitar nuestro sitio</a>",
		},
	}
}
...
func getNewsletterV2Contents() map[string]newsletterV2Content {
	return map[string]newsletterV2Content{
		"en": {
			...
			footerText:      "You're receiving this because you subscribed to our weekly digest.<br><a href=\"{{unsubscribe_url}}\">Unsubscribe</a> | <a href=\"https://email.indobase.in/preferences\">Manage Preferences</a>",
		},
		"fr": {
			lang:            "fr",
			...
			footerText:      "Vous recevez ceci car vous êtes abonné(e) à notre résumé hebdomadaire.<br><a href=\"{{unsubscribe_url}}\">Se désabonner</a> | <a href=\"https://email.indobase.in/preferences\">Gérer les préférences</a>",
		},
		"es": {
			lang:            "es",
			...
			footerText:      "Recibes esto porque te suscribiste a nuestro resumen semanal.<br><a href=\"{{unsubscribe_url}}\">Cancelar suscripción</a> | <a href=\"https://email.indobase.in/preferences\">Gestionar preferencias</a>",
		},
	}
}
...
func (s *DemoService) createNewsletterMJMLStructure(c newsletterContent) notifuse_mjml.EmailBlock {
	...
	buttonBase.Attributes["href"] = "https://email.indobase.in/newsletter?utm_source={{utm_source}}&utm_medium={{utm_medium}}&utm_campaign={{utm_campaign}}"
...
func (s *DemoService) createNewsletterV2MJMLStructure(c newsletterV2Content) notifuse_mjml.EmailBlock {
	...
	buttonBase2.Attributes["href"] = "https://email.indobase.in/weekly-digest?utm_source={{utm_source}}&utm_medium={{utm_medium}}&utm_campaign={{utm_campaign}}"
...
func (s *DemoService) createWelcomeMJMLStructure(c welcomeContent) notifuse_mjml.EmailBlock {
	...
	buttonBase3.Attributes["href"] = "https://email.indobase.in/getting-started?utm_source={{utm_source}}&utm_medium={{utm_medium}}&utm_campaign={{utm_campaign}}"
...
func (s *DemoService) generateTransactionalMessageHistoryForContact(contact *domain.Contact, templateID string, templateVersion int64, messageType string, baseTime time.Time) (*domain.MessageHistory, messageEngagement) {
	...
	if messageType == "password-reset" {
		messageData.Data["reset_url"] = "https://email.indobase.in/reset-password?token=demo_token_123"
	}
