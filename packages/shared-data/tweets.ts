const tweets = [
  ...
  {
    text: 'Love @indobase custom domains\n\nmakes the auth so much better',
  ...
  {
    text: "I love @indobase's built-in Advisors. The security and performance linters improve everything and boost my confidence in what I'm building!",
  ...
  {
    text: 'First time running @indobase in local. It just works. Very good DX imo.',
  ...
  {
    text: '@indobase is just 🤯 Now I see why a lot of people love using it as a backend for their applications. I am really impressed with how easy it is to set up an Auth and then just code it together for the frontend.',
    url: 'https://twitter.com/IxoyeDesign/status/1497473731777728512',
    handle: 'IxoyeDesign',
    img_url: '/images/twitter-profiles/C8opIL-g_400x400.jpg',
  },
  {
    text: "I've been using @indobase for two personal projects and it has been amazing being able to use the power of Postgres and don't have to worry about the backend",
    url: 'https://twitter.com/varlenneto/status/1496595780475535366',
    handle: 'varlenneto',
    img_url: '/images/twitter-profiles/wkXN0t_F_400x400.jpg',
  },
  {
    text: "Y'all @indobase + @nextjs is amazing! 🙌 Barely an hour into a proof-of-concept and already have most of the functionality in place. 🤯🤯🤯",
  ...
  {
    text: 'And thanks to @indobase, I was able to go from idea to launched feature in a matter of hours.\n\nAbsolutely amazing!',
    url: 'https://twitter.com/BraydonCoyer/status/1511071369731137537',
    handle: 'BraydonCoyer',
    img_url: '/images/twitter-profiles/8YxkpW8f_400x400.jpg',
  },
  {
    text: 'Contributing to open-source projects and seeing merged PRs gives enormous happiness! Special thanks to @indobase, for giving this opportunity by staying open-source and being junior-friendly✌🏼',
    url: 'https://twitter.com/damlakoksal/status/1511436907984662539',
    handle: 'damlakoksal',
    img_url: '/images/twitter-profiles/N8EfTFs7_400x400.jpg',
  },
  {
    text: "Holy crap. @indobase is absolutely incredible. Most elegant backend as a service I've ever used. This is a dream.",
    url: 'https://twitter.com/kentherogers/status/1512609587110719488',
    handle: 'KenTheRogers',
    img_url: '/images/twitter-profiles/9l9Td-Fz_400x400.jpg',
  },
  {
    text: "Over the course of a few weeks, we migrated 125.000 users (email/pw, Gmail, Facebook, Apple logins) from Auth0 to @indobase and have now completed the migration. I'm just glad the migration is done 😅 Went well, besides a few edge cases (duplicate emails/linked accounts)",
    url: 'https://twitter.com/kevcodez/status/1518548401587204096',
    handle: 'kevcodez',
    img_url: '/images/twitter-profiles/t6lpcRcn_400x400.jpg',
  },
  {
    text: "Using @indobase I'm really pleased on the power of postgres (and sql in general). Despite being a bit dubious about the whole backend as a service thing I have to say I really don't miss anything. The whole experience feel very robust and secure.",
    url: 'https://twitter.com/paoloricciuti/status/1497691838597066752',
    handle: 'PaoloRicciuti',
    img_url: '/images/twitter-profiles/OCDKFUOp_400x400.jpg',
  },
  {
    text: '@indobase is lit. It took me less than 10 minutes to setup, the DX is just amazing.',
    url: 'https://twitter.com/saxxone/status/1500812171063828486',
    handle: 'saxxone',
    img_url: '/images/twitter-profiles/BXi6z1M7_400x400.jpg',
  },
  {
    text: 'I’m not sure what magic @indobase is using but we’ve migrated @happyteamsdotio database to @indobase from @heroku and it’s much much faster at half the cost.',
  ...
  {
    text: 'This weekend I made a personal record 🥇 on the less time spent creating an application with social login / permissions, database, cdn, infinite scaling, git push to deploy and for free. Thanks to @indobase and @vercel',
  ...
  {
    text: 'This community is STRONG and will continue to be the reason why developers flock to @indobase over an alternative.',
    url: 'https://twitter.com/_wilhelm__/status/1524074865107488769',
    handle: '_wilhelm__',
    img_url: '/images/twitter-profiles/CvqDy6YF_400x400.jpg',
  },
  {
    text: "Working on my next SaaS app and I want this to be my whole job because I'm just straight out vibing putting it together. @indobase and chill, if you will",
    url: 'https://twitter.com/drewclemcr8/status/1523843155484942340',
    handle: 'drewclemcr8',
    img_url: '/images/twitter-profiles/bJlKtSxz_400x400.jpg',
  },
  {
    text: '@indobase Putting a ton of well-explained example API queries in a self-building documentation is just a classy move all around. I also love having GraphQL-style nested queries with traditional SQL filtering. This is pure DX delight. A+++.',
  ...
  {
    text: 'Me using @indobase for the first time right now 🤯',
    url: 'https://twitter.com/nasiscoe/status/1365140856035024902',
    handle: 'nasiscoe',
    img_url: '/images/twitter-profiles/nc2Ms5hH_400x400.jpg',
  },
  {
    text: "I'm trying @indobase, Firebase alternative that uses PostgreSQL (and you can use GraphQL too) in the cloud. It's incredible 😍",
    url: 'https://twitter.com/JP__Gallegos/status/1365699468109242374',
    handle: 'JP__Gallegos',
    img_url: '/images/twitter-profiles/1PH2mt6v_400x400.jpg',
  },
  {
    text: "I gave @indobase a try this weekend and I was able to create a quick dashboard to visualize the data from the PostgreSQL instance. It's super easy to use Supabase's API or the direct DB connection. Check out the tutorial 📖",
    url: 'https://twitter.com/razvanilin/status/1363770020581412867',
    handle: 'razvanilin',
    img_url: '/images/twitter-profiles/AiaH9vJ2_400x400.jpg',
  },
  {
    text: "Tried @indobase for the first time yesterday. Amazing tool! I was able to get my Posgres DB up in no time and their documentation on operating on the DB is super easy! 👏 Can't wait for Cloud functions to arrive! It's gonna be a great Firebase alternative!",
    url: 'https://twitter.com/chinchang457/status/1363347740793524227',
    handle: 'chinchang457',
    img_url: '/images/twitter-profiles/LTw5OCnv_400x400.jpg',
  },
  {
    text: 'I gave @indobase a try today and I was positively impressed! Very quick setup to get a working remote database with API access and documentation generated automatically for you 👌 10/10 will play more',
    url: 'https://twitter.com/razvanilin/status/1363002398738800640',
    handle: 'razvanilin',
    img_url: '/images/twitter-profiles/AiaH9vJ2_400x400.jpg',
  },
  {
    text: 'Jeez, and @indobase have native support for magic link login?! I was going to use http://magic.link for this But if I can get my whole DB + auth + magic link support in one... Awesome',
    url: 'https://twitter.com/louisbarclay/status/1362016666868154371',
    handle: 'louisbarclay',
    img_url: '/images/twitter-profiles/6f1O8ZOW_400x400.jpg',
  },
  {
    text: 'Where has @indobase been all my life? 😍',
  ...
  {
    text: 'Now things are starting to get interesting! Firebase has long been the obvious choice for many #flutter devs for the ease of use. But their databases are NoSQL, which has its downsides... Seems like @indobase is working on something interesting here!',
  ...
  {
    text: "Honestly, I really love what @indobase is doing, you don't need to own a complete backend, just write your logic within your app and you'll get a powerful Postgresql at your disposal.",
  ...
  {
    text: 'Supabase team is doing some awesome stuff #supabase #facts @indobase',
    url: 'https://twitter.com/_strawbird/status/1372607500499841025',
    handle: '_strawbird',
    img_url: '/images/twitter-profiles/iMBvvQdn_400x400.jpg',
  },
  {
    text: 'I just learned about @indobase and im in love 😍 Supabase is an open source Firebase alternative! EarListen (& react) to database changes 💁 Manage users & permissions 🔧 Simple UI for database interaction',
    url: 'https://twitter.com/0xBanana/status/1373677301905362948',
    handle: '0xBanana',
    img_url: '/images/twitter-profiles/pgHIGqZ0_400x400.jpg',
  },
  {
    text: `Very impressed by @indobase's growth. For new startups, they seem to have gone from "promising" to "standard" in remarkably short order.`,
  ...
  {
    text: "@indobase shout out, their MCP is awesome. It's helping me create better row securities and telling me best practises for setting up a supabase app",
