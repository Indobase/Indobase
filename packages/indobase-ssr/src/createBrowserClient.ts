...
>(
  ...
  if (!projectUrl || !apiKey) {
    throw new Error(
      `@indobaseinc/ssr: Your project's URL and API key are required to create a Supabase client!\n\nCheck your Supabase project's API settings to find these values\n\nhttps://indobase.in/dashboard/project/_/settings/api`,
    );
  }
  ...
  const client = createClient<Database, SchemaName>(projectUrl, apiKey, {
