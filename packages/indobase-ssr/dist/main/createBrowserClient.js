...
const supabase_js_1 = require("indobase-js");
const version_1 = require("./version");
const utils_1 = require("./utils");
const cookies_1 = require("./cookies");
let cachedBrowserClient;
function createBrowserClient(projectUrl, apiKey, options) {
    ...
    const client = (0, supabase_js_1.createClient)(projectUrl, apiKey, {
