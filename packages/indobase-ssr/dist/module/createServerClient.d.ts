import { IndobaseClient, IndobaseClientOptions } from "indobase-js";
 ...
 * version.
 */
export declare function createServerClient<Database = any, SchemaName extends string & keyof Omit<Database, "__InternalSupabase"> = "public" extends keyof Omit<Database, "__InternalSupabase"> ? "public" : string & keyof Omit<Database, "__InternalSupabase">>(projectUrl: string, apiKey: string, options: IndobaseClientOptions<SchemaName> & {
 ...
 *
 * @param projectUrl The URL of the Supabase project.
 * @param apiKey The `anon` API key of the Supabase project.
