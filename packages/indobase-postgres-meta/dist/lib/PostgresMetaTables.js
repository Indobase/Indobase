...
select
  *
  ...
  , ${coalesceRowsToArray('relationships', `(relationships.source_schema = tables.schema AND relationships.source_table_name = tables.name)
