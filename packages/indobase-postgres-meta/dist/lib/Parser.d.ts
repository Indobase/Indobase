 ...
 */
export declare function Parse(sql: string): ParseReturnValues;
 ...
 */
export declare function Deparse(parsedSql: object): DeparseReturnValues;
 ...
 */
export declare function Format(sql: string, options?: FormatterOptions): FormatReturnValues;
