...
export const postgresFunctionCreateFunction = Type.Object({
    ...
    behavior: Type.Optional(Type.Union([Type.Literal('IMMUTABLE'), Type.Literal('STABLE'), Type.Literal('VOLATILE')])),
...
export const postgresTableUpdateSchema = Type.Object({
    ...
    replica_identity: Type.Optional(Type.Union([
        Type.Literal('DEFAULT'),
        Type.Literal('INDEX'),
        Type.Literal('FULL'),
        Type.Literal('NOTHING'),
...
export const postgresTypeSchema = Type.Object({
    ...
    format: Type.String(),
    enums: Type.Array(Type.String()),
    attributes: Type.Array(Type.Object({
        name: Type.String(),
