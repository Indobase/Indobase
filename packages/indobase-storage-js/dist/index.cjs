...
var StorageFileApi = class extends BaseApiClient {
	...
	* {
	*   "data": {
	*     "signedUrl": "https://example.indobase.in/storage/v1/object/upload/sign/avatars/folder/cat.jpg?token=<TOKEN>",
	*     "path": "folder/cat.jpg",
	*     "token": "<TOKEN>"
	*   },
	*   "error": null
	...
	* {
	*   "data": {
	*     "signedUrl": "https://example.indobase.in/storage/v1/object/sign/avatars/folder/avatar1.png?token=<TOKEN>"
	*   },
	*   "error": null
	* }
	* ```
	...
	*       "signedUrl": "https://example.indobase.in/storage/v1/object/sign/avatars/folder/avatar2.png?token=<TOKEN>"
	*     }
	*   ],
	*   "error": null
	* }
	...
	* {
	*   "data": {
	*     "publicUrl": "https://example.indobase.in/storage/v1/object/public/public-bucket/folder/avatar1.png"
	*   }
	* }
	* ```
	*
...
var StorageClient = class extends StorageBucketApi {
	...
	*
	* const storage = new StorageClient('https://xyzcompany.indobase.in/storage/v1', {
