...
<p align="center">
  ...
  <p align="center">
    <a href="https://indobase.in/docs/guides/storage">Guides</a>
    ·
    <a href="https://indobase.in/docs/reference/javascript/storage-createbucket">Reference Docs</a>
    ·
...
[![Build](https://github.com/Indobase/supabase-js/workflows/CI/badge.svg)](https://github.com/Indobase/supabase-js/actions?query=branch%3Amaster)
[![Package](https://img.shields.io/npm/v/@indobaseinc/storage-js)](https://www.npmjs.com/package/@indobaseinc/storage-js)
...
```bash
npm install @indobaseinc/storage-js
```
...
If you're already using `indobase-js`, access storage through the client:

```js
import { createClient } from 'indobase-js'

// Use publishable/anon key for frontend applications
const supabase = createClient('https://<project_ref>.indobase.in', '<your-publishable-key>')
...
```js
import { StorageClient } from '@indobaseinc/storage-js'

const STORAGE_URL = 'https://<project_ref>.indobase.in/storage/v1'
...
> **Note:** Refer to the [Storage Access Control guide](https://indobase.in/docs/guides/storage/access-control) for detailed information on creating RLS policies.
...
- Upload a file to an existing bucket:
  ...
  > Note: The `upload` method also accepts a map of optional parameters. For a complete list see the [Supabase API reference](https://indobase.in/docs/reference/javascript/storage-from-upload).
...
- List all the files within a bucket:
  ...
  > Note: The `list` method also accepts a map of optional parameters. For a complete list see the [Supabase API reference](https://indobase.in/docs/reference/javascript/storage-from-list).
...
const supabase = createClient('https://your-project.indobase.in', 'your-publishable-key')
...
const storageClient = new StorageClient('https://your-project.indobase.in/storage/v1', {
  apikey: 'YOUR_API_KEY',
...
```typescript
import type { AnalyticBucket, BucketType, StorageError } from '@indobaseinc/storage-js'
...
> **Note:** Vector embeddings functionality is available in `@indobaseinc/storage-js` v2.76 and later.
...
```typescript
import { StorageVectorsClient } from '@indobaseinc/storage-js'

// Initialize standalone vector client
const vectorClient = new StorageVectorsClient('https://your-project.indobase.in/storage/v1', {
...
```typescript
import { normalizeToFloat32 } from '@indobaseinc/storage-js'
...
import type {
  ...
  ApiResponse,
  StorageVectorsError,
} from '@indobaseinc/storage-js'
```

## Development

This package is part of the [Supabase JavaScript monorepo](https://github.com/Indobase/supabase-js). To work on this package:
