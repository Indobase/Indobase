              ...
              <Admonition
                ...
                description={
                  <>
                    ...
                    <Link href="https://indobase.in/dashboard/support/new" className="underline">
                      contact support
                    </Link>
                    .
                  </>
      ...
      <Toggle
        ...
        descriptionText={
          <>
            ...
            <br />
            <Link
              href="https://indobase.in/privacy#8-cookies-and-similar-technologies-used-on-our-european-services"
              className="underline"
            >
              Learn more
            </Link>
