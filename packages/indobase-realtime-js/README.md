...
<p align="center">
  ...
  <p align="center">
    <a href="https://indobase.in/docs/guides/realtime">Guides</a>
    ·
    <a href="https://indobase.in/docs/reference/javascript">Reference Docs</a>
    ·
...
[![Package](https://img.shields.io/npm/v/@indobaseinc/realtime-js)](https://www.npmjs.com/package/@indobaseinc/realtime-js)
...
```bash
npm install @indobaseinc/realtime-js
```

## Creating a Channel

```js
import { RealtimeClient } from '@indobaseinc/realtime-js'
...
- `REALTIME_URL` is `'ws://localhost:4000/socket'` when developing locally and `'wss://<project_ref>.indobase.in/realtime/v1'` when connecting to your Supabase project.
...
Broadcast Replay enables **private** channels to access messages that were sent earlier. Only messages published via [Broadcast From the Database](https://indobase.in/docs/guides/realtime/broadcast#trigger-broadcast-messages-from-your-database) are available for replay.
