...
export default class RealtimeClient {
   ...
   * @param options.workerUrl The URL of the worker script. Defaults to https://realtime.indobase.inm/worker.js that includes a heartbeat event call to keep the connection alive.
   * @param options.vsn The protocol version to use when connecting. Supported versions are "1.0.0" and "2.0.0". Defaults to "2.0.0".
   * @example
   * ```ts
   * import RealtimeClient from '@indobaseinc/realtime-js'
   *
   * const client = new RealtimeClient('https://xyzcompany.indobase.in/realtime/v1', {
