...
```shell
npm i @indobaseinc/mcp-utils
```

```shell
yarn add @indobaseinc/mcp-utils
```

```shell
pnpm add @indobaseinc/mcp-utils
```
...
import { PostgrestMcpServer } from '@Indobase/mcp-server-postgrest';
