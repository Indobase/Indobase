import { GoTrueClientOptions } from '@indobaseinc/auth-js'
import { RealtimeClientOptions } from '@indobaseinc/realtime-js'
import { PostgrestError } from '@indobaseinc/postgrest-js'
import type { StorageClientOptions } from '@indobaseinc/storage-js'
import type {
  GenericSchema,
  GenericRelationship,
  GenericTable,
