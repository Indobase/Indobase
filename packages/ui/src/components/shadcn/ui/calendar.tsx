  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected: cn('bg-brand-500 text-foreground-contrast dark:text-foreground', selected),
        ...
        range_middle: cn('aria-selected:bg-brand-400 aria-selected:text-foreground-contrast rounded-none', range_middle),
