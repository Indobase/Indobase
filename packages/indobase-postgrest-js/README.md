...
<p align="center">
  ...
  <p align="center">
    <a href="https://indobase.in/docs/guides/database">Guides</a>
    ·
    <a href="https://indobase.in/docs/reference/javascript/select">Reference Docs</a>
    ·
...
[![Package](https://img.shields.io/npm/v/@indobaseinc/postgrest-js)](https://www.npmjs.com/package/@indobaseinc/postgrest-js)
...
```bash
npm install @indobaseinc/postgrest-js
```

Usage

```js
import { PostgrestClient } from '@indobaseinc/postgrest-js'

const REST_URL = 'http://localhost:3000'
const postgrest = new PostgrestClient(REST_URL)
```

- [select()](https://indobase.in/docs/reference/javascript/select)
- [insert()](https://indobase.in/docs/reference/javascript/insert)
- [update()](https://indobase.in/docs/reference/javascript/update)
- [delete()](https://indobase.in/docs/reference/javascript/delete)
...
**Supabase CLI Required!** The `postgrest-js` tests use the [Supabase CLI](https://indobase.in/docs/guides/local-development/cli/getting-started) to run a local PostgreSQL database and PostgREST server.
...
- **Supabase CLI** must be installed ([instructions](https://indobase.in/docs/guides/local-development/cli/getting-started)) or can be used through `npx` (`npx supabase`)
