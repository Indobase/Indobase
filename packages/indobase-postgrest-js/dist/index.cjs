...
var PostgrestBuilder = class {
	...
	*   new URL('https://xyzcompany.indobase.in/rest/v1/users'),
	...
	*
	* {@link https://github.com/Indobase/supabase-js/issues/92}
	*/
	throwOnError() {
...
var PostgrestTransformBuilder = class extends PostgrestBuilder {
	...
	* [db_plan_enabled](https://indobase.in/docs/guides/database/debugging-performance#enabling-explain)
...
* generator](https://indobase.in/docs/reference/javascript/next/typescript-support)
*
...
var PostgrestClient = class PostgrestClient {
	...
	*
	* const postgrest = new PostgrestClient('https://xyzcompany.indobase.in/rest/v1', {
	*   headers: { apikey: 'public-anon-key' },
	*   schema: 'public',
