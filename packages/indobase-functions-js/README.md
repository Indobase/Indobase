...
<p align="center">
  ...
  <p align="center">
    <a href="https://indobase.in/docs/guides/functions">Guides</a>
    ·
    <a href="https://indobase.in/docs/reference/javascript/functions-invoke">Reference Docs</a>
    ·
...
[![Package](https://img.shields.io/npm/v/@indobaseinc/functions-js)](https://www.npmjs.com/package/@indobaseinc/functions-js)
...
```bash
npm install @indobaseinc/functions-js
```
...
const functionsUrl = 'https://<project_ref>.indobase.in/functions/v1'
