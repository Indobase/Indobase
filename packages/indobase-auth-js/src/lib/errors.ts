 ...
 * @example
 * ```ts
 * import { AuthError } from '@indobaseinc/auth-js'
 *
 ...
 * @example
 * ```ts
 * import { AuthApiError } from '@indobaseinc/auth-js'
 *
 ...
 * @example
 * ```ts
 * import { AuthUnknownError } from '@indobaseinc/auth-js'
 *
 * try {
 *   await someAuthCall()
 * } catch (err) {
 ...
 * @example
 * ```ts
 * import { CustomAuthError } from '@indobaseinc/auth-js'
 *
 ...
 * @example
 * ```ts
 * import { AuthSessionMissingError } from '@indobaseinc/auth-js'
 *
 ...
 * @example
 * ```ts
 * import { AuthInvalidTokenResponseError } from '@indobaseinc/auth-js'
 *
 ...
 * @example
 * ```ts
 * import { AuthInvalidCredentialsError } from '@indobaseinc/auth-js'
 *
 ...
 * @example
 * ```ts
 * import { AuthImplicitGrantRedirectError } from '@indobaseinc/auth-js'
 *
 ...
 * @example
 * ```ts
 * import { AuthPKCEGrantCodeExchangeError } from '@indobaseinc/auth-js'
 *
 ...
 * @example
 * ```ts
 * import { AuthPKCECodeVerifierMissingError } from '@indobaseinc/auth-js'
 *
  ...
  constructor() {
    super(
      'PKCE code verifier not found in storage. ' +
        ...
        'use @indobaseinc/ssr on both the server and client to store the code verifier in cookies.',
 ...
 * @example
 * ```ts
 * import { AuthRetryableFetchError } from '@indobaseinc/auth-js'
 *
 ...
 * @example
 * ```ts
 * import { AuthWeakPasswordError } from '@indobaseinc/auth-js'
 *
 ...
 * @example
 * ```ts
 * import { AuthInvalidJwtError } from '@indobaseinc/auth-js'
 *
