...
<p align="center">
  ...
  <h3 align="center">An isomorphic JavaScript SDK for the <a href="https://github.com/Indobase/auth">Supabase Auth</a> API.</h3>

  <p align="center">
    <a href="https://indobase.in/docs/guides/auth">Guides</a>
    ·
    <a href="https://indobase.in/docs/reference/javascript/auth-signup">Reference Docs</a>
    ·
...
[![Package](https://img.shields.io/npm/v/@indobaseinc/auth-js)](https://www.npmjs.com/package/@indobaseinc/auth-js)
...
```bash
npm install --save @indobaseinc/auth-js
```
...
- `signUp()`: https://indobase.in/docs/reference/javascript/auth-signup
- `signIn()`: https://indobase.in/docs/reference/javascript/auth-signin
- `signOut()`: https://indobase.in/docs/reference/javascript/auth-signout
...
- **Supabase CLI** - Required for main test suite ([installation guide](https://indobase.in/docs/guides/cli))
