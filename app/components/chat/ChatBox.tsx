  ...
  return (
    <div
      className={classNames(
        'relative z-prompt mx-auto w-full max-w-chat overflow-hidden rounded-2xl border border-bolt-elements-borderColor bg-bolt-elements-background-depth-2 p-3 shadow-sm',
