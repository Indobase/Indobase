    ...
    try {
      ...
      if (
        ...
        return {
          ...
          responseTime: 0,
          error:
            'CORS_ERROR: LM Studio server is blocking cross-origin requests. Try enabling CORS in LM Studio settings or route requests through a local proxy that allows Indobase Builder.',
        };
      }
