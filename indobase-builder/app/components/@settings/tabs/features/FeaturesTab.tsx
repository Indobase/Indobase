...
const FeatureSection = memo(
  ({
    ...
    >
      <div className="flex items-center gap-3">
        <div className={classNames(icon, 'text-xl text-accent-600 dark:text-accent-400')} />
        <div>
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h4 className="text-sm font-medium text-bolt-elements-textPrimary group-hover:text-accent-700 dark:group-hover:text-accent-300 transition-colors">
              Prompt Library
            </h4>
