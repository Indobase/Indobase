    ...
    <div className="space-y-4">
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          <div className="i-ph:palette-fill w-4 h-4 text-accent-600 dark:text-accent-400" />
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          <div className="i-ph:clock-fill w-4 h-4 text-accent-600 dark:text-accent-400" />
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          <div className="i-ph:keyboard-fill w-4 h-4 text-accent-600 dark:text-accent-400" />
