    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          >
            <div className="i-ph:user-circle w-4 h-4 text-gray-400 group-hover:text-accent-700 dark:group-hover:text-accent-300 transition-colors" />
            Edit Profile
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:gear-six w-4 h-4 text-gray-400 group-hover:text-accent-700 dark:group-hover:text-accent-300 transition-colors" />
            Settings
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:bug w-4 h-4 text-gray-400 group-hover:text-accent-700 dark:group-hover:text-accent-300 transition-colors" />
            Report Bug
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:download w-4 h-4 text-gray-400 group-hover:text-accent-700 dark:group-hover:text-accent-300 transition-colors" />
            Download Debug Log
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:question w-4 h-4 text-gray-400 group-hover:text-accent-700 dark:group-hover:text-accent-300 transition-colors" />
            Help & Documentation
          </DropdownMenu.Item>
        </DropdownMenu.Content>
      </DropdownMenu.Portal>
