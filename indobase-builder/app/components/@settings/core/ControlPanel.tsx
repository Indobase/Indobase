...
const BetaLabel = () => (
  <div className="absolute top-2 right-2 px-1.5 py-0.5 rounded-full bg-accent-500/15 dark:bg-accent-500/20">
    <span className="text-[10px] font-medium text-accent-700 dark:text-accent-300">BETA</span>
  </div>
);
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                  <div className="flex items-center space-x-4">
                    {(activeTab || showTabManagement) && (
                      <button
                        onClick={handleBack}
                        className="flex items-center justify-center w-8 h-8 rounded-full bg-transparent hover:bg-accent-500/10 dark:hover:bg-accent-500/15 group transition-colors duration-150"
                      >
                        <div className="i-ph:arrow-left w-4 h-4 text-gray-500 dark:text-gray-400 group-hover:text-accent-600 transition-colors" />
                      </button>
                    )}
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <button
                      onClick={handleClose}
                      className="flex items-center justify-center w-8 h-8 rounded-full bg-transparent hover:bg-accent-500/10 dark:hover:bg-accent-500/15 group transition-all duration-200"
                    >
                      <div className="i-ph:x w-4 h-4 text-gray-500 dark:text-gray-400 group-hover:text-accent-600 transition-colors" />
                    </button>
                  </div>
                </div>
