...
describe('shop catalog tools', () => {
  ...
  it('hard rules require setupShopCatalog, imagery, and live admin (no republish)', () => {
    ...
    assert.match(SHOP_CATALOG_AGENT_HARD_RULES, /connectGateway|Commerce/)
    assert.match(SHOP_CATALOG_AGENT_HARD_RULES, /storefront_html|Commerce|store ladder|Payments last/i)
