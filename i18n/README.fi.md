...
[Indobase](https://indobase.in) on avoimen lähdekoodin Firebase-vaihtoehto. Rakennamme Firebasen ominaisuuksia käyttäen yritystason avoimen lähdekoodin työkaluja.

- [x] Hosted Postgres Database. [Docs](https://indobase.in/docs/guides/database)
- [x] Tunnistus ja valtuutus. [Docs](https://indobase.in/docs/guides/auth)
- [x] Automaattisesti luodut API:t.
  - [x] REST. [Asiakirjat](https://indobase.in/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Asiakirjat](https://indobase.in/docs/guides/api#graphql-api-overview)
  - [x] Reaaliaikaiset tilaukset. [Asiakirjat](https://indobase.in/docs/guides/api#realtime-api-overview)
- [x] Funktiot.
  - [x] Tietokantafunktiot. [Docs](https://indobase.in/docs/guides/database/functions)
  - [x] Reunatoiminnot [Docs](https://indobase.in/docs/guides/functions)
- [x] Tiedostojen tallennus. [Docs](https://indobase.in/docs/guides/storage)
- [x] Kojelauta
...
Täydellinen dokumentaatio löytyy osoitteesta [indobase.in/docs](https://indobase.in/docs)

Jos haluat nähdä, miten osallistuminen tapahtuu, käy osoitteessa [Getting Started](../DEVELOPERS.md)

## Yhteisö ja tuki

- [Yhteisön foorumi](https://github.com/Indobase/Indobase/discussions). Sopii parhaiten: Apua rakentamiseen, keskustelua tietokannan parhaista käytännöistä.
- [GitHub Issues](https://github.com/Indobase/Indobase/issues). Sopii parhaiten: Supabasea käytettäessä kohdatut viat ja virheet.
- [Sähköpostituki](https://indobase.in/docs/support#business-support). Sopii parhaiten: Tietokantaan tai infrastruktuuriin liittyvät ongelmat.
- [Discord](https://discord.indobase.in). Sopii parhaiten: Sovellusten jakamiseen ja yhteisön kanssa hengailuun.

## Status

- [x] Alpha: Testaamme Supabasea suljetulla asiakasjoukolla
- [x] Julkinen Alpha: Kuka tahansa voi rekisteröityä osoitteessa [supabase.com/dashboard](https://indobase.in/dashboard). Mutta olkaa varovaisia, sillä on vielä muutamia ongelmia
- [x] Julkinen beta: Tarpeeksi vakaa useimpiin ei-yrityskäyttötapauksiin
- [ ] Julkinen: Yleinen saatavuus [[status](https://indobase.in/docs/guides/getting-started/features#feature-status)]
...
Indobase on yhdistelmä avoimen lähdekoodin työkaluja. Rakennamme Firebasen ominaisuuksia käyttäen yritystason avoimen lähdekoodin tuotteita. Jos työkalut ja yhteisöt ovat olemassa MIT-, Apache 2- tai vastaavalla avoimella lisenssillä, käytämme ja tuemme kyseistä työkalua. Jos työkalua ei ole olemassa, rakennamme sen itse ja käytämme avointa lähdekoodia. Indobase ei ole Firebasen 1:1-kartoitus. Tavoitteenamme on antaa kehittäjille Firebasen kaltainen kehittäjäkokemus käyttämällä avoimen lähdekoodin työkaluja.

**Arkkitehtuuri**

Indobase on [hosted platform](https://indobase.in/dashboard). Voit rekisteröityä ja aloittaa Supabasen käytön asentamatta mitään.
Voit myös [itse isännöidä](https://indobase.in/docs/guides/hosting/overview) ja [kehittää paikallisesti](https://indobase.in/docs/guides/local-development).

![Arkkitehtuuri](https://github.com/Indobase/Indobase/blob/master/apps/docs/public/img/indobase-architecture.svg)
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Kieli</th>
    <th>Asiakas</th>
    <th colspan="5">Feature-Clients (niputettu Indobase-asiakasohjelmaan)</th>
  </tr>
