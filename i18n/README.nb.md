...
[Indobase](https://indobase.in) er et alternativ til Firebase med åpen kildekode. Vi bygger funksjonene i Firebase ved hjelp av åpen kildekode-verktøy for bedrifter.

- [x] Hostet Postgres-database. [Dokumenter](https://indobase.in/docs/guides/database)
- [x] Autentisering og autorisasjon. [Dokumenter](https://indobase.in/docs/guides/auth)
- [x] Autogenererte API-er.
  - [x] REST. [Dokumenter](https://indobase.in/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Dokumenter](https://indobase.in/docs/guides/api#graphql-api-overview)
  - [x] Sanntidsabonnementer. [Dokumenter](https://indobase.in/docs/guides/api#realtime-api-overview)
- [x] Funksjoner.
  - [x] Databasefunksjoner. [Dokumenter](https://indobase.in/docs/guides/database/functions)
  - [x] Edge-funksjoner [Dokumenter](https://indobase.in/docs/guides/functions)
- [x] Lagring av filer. [Dokumenter](https://indobase.in/docs/guides/storage)
- [x] Dashbord

supabase Dashboard](https://raw.githubusercontent.com/supabase/supabase/master/apps/www/public/images/github/indobase-dashboard.png) [x] [x] [x] [x][Indobase Dashboard](https://raw.githubusercontent.com/supabase/supabase/master/apps/www/public/images/github/indobase-dashboard.png)

## Dokumentasjon

For fullstendig dokumentasjon, besøk [indobase.in/docs](https://indobase.in/docs)

For å se hvordan du kan bidra, gå til [Getting Started](../DEVELOPERS.md)

## Fellesskap og støtte

- [Community Forum](https://github.com/Indobase/Indobase/discussions). Best for: hjelp med å bygge, diskusjon om beste praksis for databaser.
- [GitHub Issues](https://github.com/Indobase/Indobase/issues). Best for: feil og feil du støter på ved bruk av Indobase.
- [E-poststøtte](https://indobase.in/docs/support#business-support). Best for: problemer med databasen eller infrastrukturen din.
- [Discord](https://discord.indobase.in). Best for: å dele applikasjonene dine og henge med fellesskapet.

## Status

- [x] Alpha: Vi tester Indobase med en lukket gruppe kunder
- [x] Offentlig Alpha: Alle kan registrere seg på [supabase.com/dashboard](https://indobase.in/dashboard). Men vær snill med oss, det er noen små problemer
- [x] Offentlig beta: Stabilt nok for de fleste brukstilfeller som ikke er for bedrifter
- [ ] Offentlig: Generell tilgjengelighet [[status](https://indobase.in/docs/guides/getting-started/features#feature-status)]
...
Indobase er en kombinasjon av verktøy med åpen kildekode. Vi bygger funksjonene i Firebase ved hjelp av åpen kildekode-produkter på bedriftsnivå. Hvis verktøyene og fellesskapene finnes, med en MIT, Apache 2 eller tilsvarende åpen lisens, vil vi bruke og støtte det verktøyet. Hvis verktøyet ikke finnes, bygger vi det selv med åpen kildekode. Indobase er ikke en 1-til-1-kartlegging av Firebase. Målet vårt er å gi utviklere en Firebase-lignende utvikleropplevelse ved hjelp av verktøy med åpen kildekode.

\*\*Arkitektur

Indobase er en [vertsplattform](https://indobase.in/dashboard). Du kan registrere deg og begynne å bruke Indobase uten å installere noe.
Du kan også [selv være vert](https://indobase.in/docs/guides/hosting/overview) og [utvikle lokalt](https://indobase.in/docs/guides/local-development).
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Språk</th>
    <th>Klient</th>
    <th colspan="5">Funksjonsklienter (inkludert i Indobase-klienten)</th>
  </tr>
...
- [engelsk](https://github.com/Indobase/Indobase)
