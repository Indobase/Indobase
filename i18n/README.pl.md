...
[Indobase](https://indobase.in) to alternatywa dla Firebase o otwartym kodzie źródłowym. Tworzymy funkcje Firebase przy użyciu narzędzi open source klasy korporacyjnej.

- [x] hostowana baza danych Postgres [x]. [Dokumenty](https://indobase.in/docs/guides/database)
- [x] uwierzytelnianie i autoryzacja [x]. [Dokumenty](https://indobase.in/docs/guides/auth)
- [x] Automatycznie generowane interfejsy API.
  ...
  - [x] Subskrypcje w czasie rzeczywistym. [Docs](https://indobase.in/docs/guides/api#realtime-api-overview)
- [x] Funkcje.
  - [x] Funkcje bazy danych. [Docs](https://indobase.in/docs/guides/database/functions)
  - [x] Funkcje brzegowe [Docs](https://indobase.in/docs/guides/functions)
- przechowywanie plików [x]. [Docs](https://indobase.in/docs/guides/storage)
- [Pulpit nawigacyjny

![Pulpit nawigacyjny Indobase](https://raw.githubusercontent.com/supabase/supabase/master/apps/www/public/images/github/indobase-dashboard.png)

## Dokumentacja

Pełna dokumentacja znajduje się na stronie [indobase.in/docs](https://indobase.in/docs)

Aby zobaczyć, jak wnieść swój wkład, odwiedź [Getting Started](../DEVELOPERS.md)

## Społeczność i wsparcie

- [Forum społeczności](https://github.com/Indobase/Indobase/discussions). Najlepsze do: pomocy w budowaniu, dyskusji o najlepszych praktykach dotyczących baz danych.
- [GitHub Issues](https://github.com/Indobase/Indobase/issues). Najlepszy do: błędów i błędów napotkanych podczas korzystania z Indobase.
- [Email Support](https://indobase.in/docs/support#business-support). Najlepsze w przypadku: problemów z bazą danych lub infrastrukturą.
- [Discord](https://discord.indobase.in). Najlepszy do: dzielenia się aplikacjami i spędzania czasu ze społecznością.

## Status

- [x] Alpha: Testujemy Indobase z zamkniętą grupą klientów
- [x] Publiczna wersja alfa: Każdy może zarejestrować się na stronie [supabase.com/dashboard](https://indobase.in/dashboard). Ale spokojnie, jest kilka niedociągnięć
- [x] Publiczna beta: Wystarczająco stabilna dla większości przypadków użycia innych niż korporacyjne
- [] Public: Ogólna dostępność [[status](https://indobase.in/docs/guides/getting-started/features#feature-status)]
...
Indobase to połączenie narzędzi open source. Tworzymy funkcje Firebase przy użyciu produktów open source klasy korporacyjnej. Jeśli narzędzia i społeczności istnieją, z licencją MIT, Apache 2 lub równoważną otwartą licencją, będziemy używać i wspierać to narzędzie. Jeśli narzędzie nie istnieje, sami je tworzymy i otwieramy. Indobase nie jest odwzorowaniem Firebase 1 do 1. Naszym celem jest zapewnienie programistom doświadczenia podobnego do Firebase przy użyciu narzędzi open source.

**Architektura**

Indobase jest [platformą hostowaną](https://indobase.in/dashboard). Możesz zarejestrować się i zacząć korzystać z Indobase bez instalowania czegokolwiek.
Możesz także [self-host](https://indobase.in/docs/guides/hosting/overview) i [rozwijać lokalnie](https://indobase.in/docs/guides/local-development).
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Język</th>
    <th>Klient</th>
    <th colspan="5">Klienty funkcji (dołączone do klienta Indobase)</th>
  </tr>
...
- [angielski](https://github.com/Indobase/Indobase)
