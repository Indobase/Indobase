...
[Indobase](https://indobase.in) yra atvirojo kodo Firebase alternatyva. Kuriame "Firebase" funkcijas naudodami įmonių klasės atvirojo kodo įrankius.

- [x] Prieglobos Postgres duomenų bazė. [Dokumentai](https://indobase.in/docs/guides/database)
- [x] Autentiškumo nustatymas ir autorizavimas. [Dokumentai](https://indobase.in/docs/guides/auth)
- [x] Automatiškai generuojamos API.
  - [x] REST. [Dokumentai](https://indobase.in/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Dokumentai](https://indobase.in/docs/guides/api#graphql-api-overview)
  - [x] Realaus laiko prenumeratos. [Dokumentai](https://indobase.in/docs/guides/api#realtime-api-overview)
- [x] Funkcijos.
  - [x] Duomenų bazės funkcijos. [Dokumentai](https://indobase.in/docs/guides/database/functions)
  - [x] Kraštų funkcijos [Docs](https://indobase.in/docs/guides/functions)
- [x] Failų saugojimas. [Dokumentai](https://indobase.in/docs/guides/storage)
...
Išsamios dokumentacijos rasite [indobase.in/docs](https://indobase.in/docs)

Norėdami sužinoti, kaip prisidėti, apsilankykite [Getting Started](../DEVELOPERS.md)

## Bendruomenė ir palaikymas

- [Bendrijos forumas](https://github.com/Indobase/Indobase/discussions). Geriausiai tinka: pagalbai kuriant, diskusijoms apie geriausią duomenų bazių praktiką.
- [GitHub Issues](https://github.com/Indobase/Indobase/issues). Geriausia: klaidos ir klaidos, su kuriomis susiduriate naudodami "Indobase".
- [Pagalba el. paštu](https://indobase.in/docs/support#business-support). Geriausiai tinka: problemoms, susijusioms su jūsų duomenų baze ar infrastruktūra, spręsti.
- [Discord](https://discord.indobase.in). Geriausiai tinka: dalytis savo programomis ir bendrauti su bendruomene.

## Statusas

- [x] Alfa: Bandome "Indobase" su uždaru klientų rinkiniu
- [x] Viešoji Alfa versija: [supabase.com/dashboard](https://indobase.in/dashboard). Tačiau neskubėkite su mumis, yra keletas trūkumų
- [x] Viešoji beta versija: Pakankamai stabili daugeliui ne įmonių naudojimo atvejų
- [ ] Vieša: Bendras prieinamumas [[statusas](https://indobase.in/docs/guides/getting-started/features#feature-status)]
...
"Indobase" yra atvirojo kodo įrankių derinys. Kuriame "Firebase" funkcijas naudodami įmonių klasės atvirojo kodo produktus. Jei egzistuoja įrankiai ir bendruomenės, turinčios MIT, "Apache 2" ar lygiavertę atvirąją licenciją, mes naudosime ir palaikysime tą įrankį. Jei įrankis neegzistuoja, mes patys jį sukursime ir naudosime atvirąjį kodą. "Indobase" nėra "Firebase" atvaizdavimas 1:1. Mūsų tikslas - suteikti kūrėjams panašią į "Firebase" kūrėjų patirtį naudojant atvirojo kodo įrankius.

**Architektūra**

Indobase yra [prieglobos platforma](https://indobase.in/dashboard). Galite užsiregistruoti ir pradėti naudotis "Indobase" nieko neįdiegę.
Taip pat galite [savarankiškai talpinti](https://indobase.in/docs/guides/hosting/overview) ir [kurti vietoje](https://indobase.in/docs/guides/local-development).

![Architektūra](https://github.com/Indobase/Indobase/blob/master/apps/docs/public/img/indobase-architecture.svg)
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Kalba</th>
    <th>Klientas</th>
    <th colspan="5">Funkcijų klientai (įtraukti į "Indobase" klientą)</th>
  </tr>
...
- [anglų kalba](https://github.com/Indobase/Indobase)
