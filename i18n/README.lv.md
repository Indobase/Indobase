...
[Indobase](https://indobase.in) ir atvērtā koda Firebase alternatīva. Mēs veidojam Firebase funkcijas, izmantojot uzņēmumu klases atvērtā pirmkoda rīkus.

- [x] Hosted Postgres datubāze. [Dokumenti](https://indobase.in/docs/guides/database)
- [x] Autentifikācija un autorizācija. [Dokumenti](https://indobase.in/docs/guides/auth)
- [x] Automātiski ģenerēti API.
  - [x] REST. [Dokumenti](https://indobase.in/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Dokumenti](https://indobase.in/docs/guides/api#graphql-api-overview)
  - [x] Reāllaika abonēšana. [Dokumenti](https://indobase.in/docs/guides/api#realtime-api-overview)
- [x] Funkcijas.
  - [x] Datubāzes funkcijas. [Dokumenti](https://indobase.in/docs/guides/database/functions)
  - [x] Edge funkcijas [Dokumenti](https://indobase.in/docs/guides/functions)
- [x] Failu glabāšana. [Dokumenti](https://indobase.in/docs/guides/storage)
- [x] Vadības panelis
...
Pilnu dokumentāciju skatīt [indobase.in/docs](https://indobase.in/docs)

Lai uzzinātu, kā veikt iemaksas, apmeklējiet [Getting Started](../DEVELOPERS.md)

## Kopiena un atbalsts

- [Kopienas forums](https://github.com/Indobase/Indobase/discussions). Vislabāk piemērots: palīdzībai veidošanā, diskusijām par datubāzes paraugpraksi.
- [GitHub Issues](https://github.com/Indobase/Indobase/issues). Vislabākais: kļūdas un kļūdas, ar kurām jūs sastopaties, izmantojot Indobase.
- [E-pasta atbalsts](https://indobase.in/docs/support#business-support). Vislabāk piemērots: problēmām ar jūsu datu bāzi vai infrastruktūru.
- [Discord](https://discord.indobase.in). Vislabākais: lai dalītos ar savām lietojumprogrammām un komunicētu ar kopienu.

## Statuss

- [x] Alfa: Mēs testējam Indobase ar slēgtu klientu kopu
- [x] Publiskā alfa versija: [supabase.com/dashboard](https://indobase.in/dashboard). Bet nesteidzieties, ir dažas nepilnības
- [x] Publiskā beta versija: Pietiekami stabila lielākajai daļai ar uzņēmumu nesaistītu lietošanas gadījumu
- [ ] Publisks: Vispārēja pieejamība [[statuss](https://indobase.in/docs/guides/getting-started/features#feature-status)]]
...
Indobase ir atvērtā koda rīku kombinācija. Mēs veidojam Firebase funkcijas, izmantojot atvērtā pirmkoda produktus, kas paredzēti uzņēmumiem. Ja pastāv rīki un kopienas ar MIT, Apache 2 vai līdzvērtīgu atvērto licenci, mēs izmantosim un atbalstīsim šo rīku. Ja rīks nepastāv, mēs paši to izveidosim un izveidosim ar atklātā pirmkoda licenci. Indobase nav Firebase kartēšana 1 pret 1. Mūsu mērķis ir nodrošināt izstrādātājiem Firebase līdzīgu izstrādātāja pieredzi, izmantojot atvērtā koda rīkus.

**Arhitektūra**

Indobase ir [izvietota platforma](https://indobase.in/dashboard). Jūs varat reģistrēties un sākt izmantot Indobase, neko neinstalējot.
Jūs varat arī [pašmāju resursus](https://indobase.in/docs/guides/hosting/overview) un [izstrādāt lokāli](https://indobase.in/docs/guides/local-development).

![Arhitektūra](https://github.com/Indobase/Indobase/blob/master/apps/docs/public/img/indobase-architecture.svg)
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Valoda</th>
    <th>Klients</th>
    <th colspan="5">Funkciju klienti (komplektā ar Indobase klientu)</th>
  </tr>
...
- [angļu valodā](https://github.com/Indobase/Indobase)
