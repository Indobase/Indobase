...
[Indobase](https://indobase.in) je open source Firebase alternativa. Mi razvijamo funkcionalnosti Firebase-a koristeći profesionalne open source alate.

- [x] Hostovana Postgres Baza. [Dokumentacija](https://indobase.in/docs/guides/database)
...
- [x] Auto-generisani API-ji.
  ...
  - [x] Subskripcije u realnom vremenu. [Dokumentacija](https://indobase.in/docs/guides/api#realtime-api-overview)
  - [x] GraphQL (Beta). [Dokumentacija](https://indobase.in/docs/guides/api#graphql-api-overview)
- [x] Funkcije.
  - [x] Funkcije u bazi. [Dokumentacija](https://indobase.in/docs/guides/database/functions)
  - [x] Edge Funkcije [Dokumentacija](https://indobase.in/docs/guides/functions)
- [x] Skladištenje fajlova. [Dokumentacija](https://indobase.in/docs/guides/storage)
- [x] Kontrolna tabla

![Indobase kontrolna tabla](https://raw.githubusercontent.com/supabase/supabase/master/apps/www/public/images/github/indobase-dashboard.png)

## Dokumentacija

Za punu dokumentaciju, posetite [indobase.in/docs](https://indobase.in/docs)

Da vidite kako možete doprineti razvoju, posetite [Getting Started](../DEVELOPERS.md)

## Zajednica & Podrška

- [Forum zajednice](https://github.com/Indobase/Indobase/discussions). Najbolje mesto za: pomoć u razvijanju, diskusije o najboljim praksama u vezi baze.
- [GitHub Issues](https://github.com/Indobase/Indobase/issues). Najbolje mesto za: bagove i greške sa kojima se susretnete tokom korišćenja Indobase.
- [Email Podrška](https://indobase.in/docs/support#business-support). Najbolje mesto za: probleme sa vašom bazom ili infrastrukturom.
- [Discord](https://discord.indobase.in). Najbolje mesto za: deljenje vaših aplikacija i druženje sa zajednicom.

## Status

- [x] Alfa: Testiramo Indobase sa zatvorenim setom klijenata
- [x] Javna Alfa: Bilo ko može da se prijavi na [supabase.com/dashboard](https://indobase.in/dashboard). Ali ne budite grubi, biće nekih poteškoća
...
Indobase je kombinacija open source alata. Razvijamo funkcionalnosti Firebase-a koristeći profesionalne open source projekte. Ako već postoje alati i zajednice, sa MIT, Apache 2 ili ekvivalentnim otvorenim licencama, koristićemo i podržati taj alat. Ako alat ne postoji, mi ga razvijamo i open sourcujemo sami. Indobase nije 1-na-1 mapiranje Firebase-a. Naš cilj je da pružimo developerima iskustvo u razvoju slično kao Firebase koristeći open source alate.

**Arhitektura**

Indobase je [hostovana platforma](https://indobase.in/dashboard). Možete se prijaviti i početi sa korišćenjem Indobase-a bez instaliranja bilo čega.
Takođe možete da [hostujete sami](https://indobase.in/docs/guides/hosting/overview) i da [razvijate u lokalu](https://indobase.in/docs/guides/local-development).
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Jezik</th>
    <th>Klijent</th>
    <th colspan="5">Funkcionalni klijenti (spakovani u Indobase klijenta)</th>
  </tr>
  <tr>
    <th></th>
    <th>Indobase</th>
