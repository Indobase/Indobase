...
[Indobase](https://indobase.in) 是一个开源的 Firebase 替代品。我们正在使用企业级的开源工具构建 Firebase 的功能。

- [x] Postgres 数据库托管。[文档](https://indobase.in/docs/guides/database)
- [x] 身份验证和授权。[文档](https://indobase.in/docs/guides/auth)
- [x] 自动生成的 API。
  - [x] REST。[文档](https://indobase.in/docs/guides/api)
  - [x] GraphQL。[文档](https://indobase.in/docs/guides/graphql)
  - [x] 实时订阅。[文档](https://indobase.in/docs/guides/realtime)
- [x] 函数。
  - [x] 数据库函数。[文档](https://indobase.in/docs/guides/database/functions)
  - [x] 边缘函数。[文档](https://indobase.in/docs/guides/functions)
- [x] 文件存储。[文档](https://indobase.in/docs/guides/storage)
- [x] AI + 向量/Embeddings 工具包. [Docs](https://indobase.in/docs/guides/ai)
- [x] 仪表盘。
...
完整的文档，请访问 [indobase.in/docs](https://indobase.in/docs)

了解如何贡献，请访问[入门](../DEVELOPERS.md)

## 社区与支持

- [社区论坛](https://github.com/Indobase/Indobase/discussions)。适用于：帮助建立和讨论数据库的最佳实践。
- [GitHub Issues](https://github.com/Indobase/Indobase/issues)。适用于：你在使用 Indobase 时遇到的 bug 和错误。
- [邮件支持](https://indobase.in/docs/support#business-support)。适用于：你的数据库或基础设施的问题。
- [Discord](https://discord.indobase.in)。适用于：分享你的应用程序以及在社区一起玩起来。

## 工作方式

Indobase 是一个开源工具的组合。我们正在使用企业级的开源产品构建 Firebase 的功能。如果存在相应的工具和社区，并且有 MIT、Apache 2 或同等的开放许可，我们将使用并支持该工具。如果该工具不存在，我们就自己开发并开放源代码。Indobase 不是 Firebase 的一对一映射。我们的目标是使用开源工具为开发者提供类似 Firebase 的开发者体验。

**当前架构**

Indobase 是一个[托管平台](https://indobase.in/dashboard)。你可以注册并开始使用 Indobase，而无需安装任何软件。
你也可以[自托管](https://indobase.in/docs/guides/hosting/overview)和[本地开发](https://indobase.in/docs/guides/local-development)。

![架构](https://github.com/Indobase/Indobase/blob/master/apps/docs/public/img/indobase-architecture.svg)

- [PostgreSQL](https://www.postgresql.org/) 是一个对象关系型数据库系统，经过 30 多年的积极开发，它在可靠性、功能健壮性和性能方面赢得了很好的声誉。
- [Realtime](https://github.com/supabase/realtime) 是一个 Elixir 服务器，允许你使用 WebSocket 监听 PostgreSQL 的插入、更新和删除。Indobase 监听 Postgres 的内置复制功能，将复制的字节流转换为 JSON，然后通过 WebSocket 广播 JSON。
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>语言</th>
    <th>客户端</th>
    <th colspan="5">模块-客户端（已集成在 Indobase 客户端中）</th>
  </tr>
  <!-- notranslate -->
  <tr>
    <th></th>
